...
/* variantes de apertura del FINAL según el resultado del partido que cumplió el objetivo
   del capítulo 15 (ver BEKA_STORY 3.0, resultFlag/introBuild). V = victoria (por defecto,
   si no hay flag), E = empate, D = derrota — la mejor de las tres, ver nota del documento. */
const BEKA_FINAL_OPENINGS = {
  V: [
    { m: "disco_seria", t: "Vale. Has sido mejor." },
    { m: "disco_seria", t: "Y eso me fastidia muchísimo, para que conste en acta." },
    { m: "disco_happy", t: "Pero también me hace una ilusión que no te puedes ni imaginar." },
  ],
  E: [
    { m: "disco_seria", t: "Empate. Los dos sacamos nota y ninguno ganó." },
    { m: "disco_seria", t: "Qué rabia." },
    { m: "disco_happy", t: "Y qué bien sienta, la verdad." },
  ],
  D: [
    { m: "disco_happy", t: "¡Por fin!" },
    { m: "disco_happy", t: "¿Lo has visto? Tu mejor nota de la carrera y perdisteis igual." },
    { m: "disco_seria", t: "Bienvenido a mi vida entera. Ahora sí siento que hemos llegado los dos." },
  ],
};
const BEKA_FINAL_REST = [
  ...
  { m: "disco_seria", t: "Después quise alcanzarte, que no es lo mismo y es bastante peor." },
  { m: "disco_seria", t: "Y en algún momento del año pasado dejé de saber cuál de las dos cosas me importaba más." },
  { m: "disco_happy", t: "Porque mientras yo intentaba adelantarte, tú te estabas convirtiendo en alguien a quien yo quería ver bien." },
  { m: "disco_seria", t: "Y eso es rarísimo tratándose de alguien al que al principio solo quería ganar." },
  { m: "disco_seria", t: "…" },
  { m: "disco_seria", t: "Te voy a decir una cosa sobre la frase. La del papel." },
  { m: "disco_seria", t: "«No reúne el perfil competitivo requerido»." },
  { m: "disco_happy", t: "Llevo siete años intentando demostrar que era mentira ganando cosas." },
  { m: "disco_seria", t: "Y resulta que la demostré el día que dejé de apuntar el marcador y seguí viniendo igual." },
  { m: "disco_seria", t: "Porque eso es competir de verdad. Seguir cuando ya no cuenta para nada." },
  { m: "disco_happy", t: "Y eso lo aprendí contigo, así que técnicamente es culpa tuya." },
  { m: "disco_seria", t: "…" },
  { m: "disco_seria", t: "No voy a dejar de competir contigo. Nunca." },
  { m: "disco_happy", t: "Pero ya no necesito ganarte para que me importe lo que te pase." },
  { m: "disco_seria", t: "Hemos empezado desde abajo." },
  { m: "disco_seria", t: "Bueno. Tú desde abajo. Yo desde un poco más abajo, con un papel doblado en la cartera." },
  { m: "disco_happy", t: "Y mira dónde estamos." },
  { m: "disco_seria", t: "No hemos llegado porque uno le haya ganado al otro." },
  ...
  { m: "disco_seria", t: "Y ya está. Se acabó el discurso, que llevo tres semanas montándolo y me ha salido peor de lo que lo tenía." },
  { m: "disco_happy", t: "Falta una cosa, pero esa te la doy otro día. Cuando vengas." },
  { m: "disco_seria", t: "Sí, tienes que volver. Obviamente tienes que volver." },
  { m: "disco_happy", t: "Y mientras tanto, sigue subiendo. Hasta arriba del todo." },
  { m: "disco_seria", t: "Quiero verte en Champions." },
  { m: "disco_happy", t: "No por ti. Por mí." },
  { m: "disco_seria", t: "Porque llevo un año diciéndole a la gente de esta barra que el tío al que vi en un campo de tierra iba a llegar." },
  { m: "disco_happy", t: "Y me han mirado raro muchas veces." },
];
...
const BEKA_STORY = {
  ...
  chapters: [{
    id: "cap1",
    title: "Choque de clases",
    trigger: () => true,
    stages: [
      /* PRÓLOGO — La chica del balón (rework 3.0, ver FUTABITA_Beka_Rework_3.0.docx). */
      { title: "La chica del balón", zone: "barrio",
        objective: "Juega un partido completo.",
        intro: [
          { m: "idle", t: "Tú eres {player}, ¿no? El del {club}." },
          { m: "angry", t: "Te he visto jugar." },
          { m: "idle", t: "No está mal." },
          { m: "angry", t: "No pongas esa cara. «No está mal» es muchísimo viniendo de mí." },
          { m: "idle", t: "Beka. Juego en otro club, uno que no te suena y no pasa nada." },
          { m: "angry", t: "Y antes de que preguntes: sí, soy bastante mejor de lo que parezco ahora mismo." },
          { m: "agotada", t: "Vengo de currar. No he dormido. Esto no es mi mejor versión." },
          { m: "idle", t: "El domingo estuve en tu partido. En la banda de enfrente, detrás de la valla." },
          { m: "angry", t: "No fui por ti, tranquilo. Fui porque juegan a las once y a esa hora yo ya estoy despierta por obligación." },
          { m: "idle", t: "Pero me quedé los noventa minutos. Y eso sí que no lo hago casi nunca." },
          { m: "angry", t: "¿Sabes qué me llamó la atención? No el gol." },
          { m: "idle", t: "El minuto ochenta. Ibais ganando de uno, tú estabas fundido y bajaste a defender un córner." },
          { m: "idle", t: "La mayoría de los que tienen tu nivel no bajan. Se quedan arriba haciendo como que estiran." },
          { m: "angry", t: "Tú bajaste. Mal, tarde y sin llegar a nada, pero bajaste." },
          { m: "idle", t: "Y eso me interesa más que un gol, porque un gol lo mete cualquiera un día suelto." },
          { m: "idle", t: "Total. Que ahora ya sé quién eres, y eso es un problema para ti." },
          { m: "angry", t: "Porque a partir de hoy voy a fijarme en algo más que en si marcas." },
          { m: "idle", t: "Quiero ver si eres tan bueno como dice la gente o si te está sosteniendo un buen mes." },
          { m: "angry", t: "Y si no lo eres, te lo voy a decir. A la cara y sin adornos." },
          { m: "idle", t: "Así que juega. Un partido, el que sea, el próximo que tengas." },
          { m: "angry", t: "Yo lo veo. Y luego te digo qué he visto." },
          { m: "celebracion", t: "Que no te va a gustar, aviso." },
        ],
        replies: [
          { t: "¿Y tú qué tal juegas?", m: "angry",
            r: [{ m: "angry", t: "Mejor que tú." }, { m: "idle", t: "…" },
              { m: "angry", t: "Vale, eso no lo sé. Todavía." },
              { m: "celebracion", t: "Pero pienso averiguarlo y pienso disfrutarlo." }] },
          { t: "¿De dónde vienes a estas horas?", m: "idle",
            r: [{ m: "agotada", t: "De trabajar." }, { m: "angry", t: "Y no, no voy a dar más detalles el primer día." },
              { m: "idle", t: "La gente pone una cara rara cuando se lo cuentas y hoy no me apetece verla." }] },
          { t: "No sabía que había alguien mirándome.", m: "idle",
            r: [{ m: "celebracion", t: "Siempre hay alguien mirándote." },
              { m: "idle", t: "Lo que pasa es que normalmente son ojeadores con carpeta y no se acercan a decírtelo." },
              { m: "angry", t: "Yo no tengo carpeta. Yo te lo digo a la cara." }] },
        ],
        setFlags: ["bekaMet"],
        snap: (g) => ({ since: todayStr(), matchCount: (g.matchHistory || []).length }),
        subs: [
        ...
        check: (g, s) => (g.matchHistory || []).slice(s.matchCount).length >= 1 },
      /* CAPÍTULO 1 — El marcador. Nace el marcador, el motivo recurrente de la campaña: es
         diálogo puro, no hay que implementar nada mecánico. */
      { title: "El marcador", zone: "cantera",
        objective: "Consigue una victoria y participa en un gol marcando o asistiendo.",
        intro: [
          { m: "idle", t: "Lo he visto. Entero, otra vez." },
          { m: "idle", t: "Has mejorado." },
          { m: "angry", t: "No demasiado. No te vengas arriba." },
          { m: "idle", t: "Pero ahora entiendo por qué la gente empezó a decir tu nombre." },
          { m: "idle", t: "Cuando alguien empieza a mejorar delante de ti, hay dos opciones." },
          { m: "idle", t: "O te alegras, le das una palmada y sigues a lo tuyo…" },
          { m: "angry", t: "…o te preguntas si vas a dejar que te pase por encima." },
          { m: "celebracion", t: "Yo soy muy de la segunda. Muchísimo." },
          { m: "idle", t: "Así que he decidido una cosa y ya está decidida, así que no discutas." },
          { m: "angry", t: "Vamos a llevar un marcador." },
          { m: "idle", t: "Tú y yo. Puntos. Aquí, en las notas del móvil." },
          { m: "celebracion", t: "Y los pongo yo, porque la idea es mía." },
          { m: "angry", t: "No te quejes, es totalmente justo." },
          { m: "idle", t: "Ah, y ya voy ganando." },
          { m: "angry", t: "Uno a cero. Por haberte encontrado yo a ti y no tú a mí." },
          { m: "celebracion", t: "Es un punto legítimo. Lo he pensado y es legítimo." },
          { m: "idle", t: "Y para que puedas empatar, hay una cosa muy fácil que puedes hacer." },
          { m: "angry", t: "Ganar." },
          { m: "idle", t: "Pero no me vale una victoria cualquiera, de esas en las que sales veinte minutos y no tocas la pelota." },
          { m: "angry", t: "Quiero que aparezcas. Que se note que estabas." },
          { m: "idle", t: "Gana un partido y mete mano en un gol. Marcándolo o dándolo, me da igual cuál." },
          { m: "celebracion", t: "Y entonces te doy tu punto." },
          { m: "angry", t: "A regañadientes. Que lo sepas desde ya." },
        ],
        replies: [
          { t: "Eso es hacer trampas.", m: "angry",
            r: [{ m: "celebracion", t: "Sí." }, { m: "angry", t: "¿Y qué vas a hacer, denunciarme?" },
              { m: "idle", t: "Ponte a uno y hablamos." }] },
          { t: "¿Y qué gano si voy ganando yo?", m: "idle",
            r: [{ m: "angry", t: "Nada." }, { m: "idle", t: "…" }, { m: "angry", t: "Es que no hay premio. Ese es el chiste." },
              { m: "celebracion", t: "Si necesitas un premio para querer ganar, ya has perdido otra cosa distinta." }] },
          { t: "Vale. Apúntalo.", m: "celebracion",
            r: [{ m: "celebracion", t: "Ya está apuntado." }, { m: "angry", t: "Lo apunté antes de venir, de hecho." },
              { m: "idle", t: "Iba a existir el marcador dijeras lo que dijeras." }] },
        ],
        setFlags: ["bekaMarcador"],
        snap: (g) => ({ since: todayStr(), matchCount: (g.matchHistory || []).length }),
        subs: [
          (g, s) => (g.matchHistory || []).slice(s.matchCount).some((m) => m.res === "V"),
          (g, s) => (g.matchHistory || []).slice(s.matchCount).reduce((a, m) => a + (m.myGoals || 0) + (m.myAssists || 0), 0) >= 1,
      ...
      { title: "Te estoy empezando a conocer", zone: "cantera",
        objective: "Cierra 3 días de objetivos y consigue una nota igual o superior a tu mejor nota anterior.",
        intro: [
          { m: "idle", t: "Ganado y con gol tuyo dentro." },
          { m: "celebracion", t: "Bien. Muy bien, de hecho." },
          { m: "angry", t: "Y no, no te doy el punto." },
          { m: "idle", t: "He estado pensándolo y he decidido que el punto me lo llevo yo, porque te lo pedí yo." },
          { m: "angry", t: "Dos a cero. No me mires así, las normas las escribo yo." },
          { m: "idle", t: "Te he visto tres partidos seguidos y ya empiezo a saber cómo juegas." },
          { m: "angry", t: "Y eso es malísimo para ti." },
          { m: "idle", t: "Sé cuándo aceleras. Es siempre después de perder un balón, como si tuvieras que compensar." },
          { m: "idle", t: "Sé cuándo te escondes. Cuando vais perdiendo de dos y queda poco." },
          { m: "idle", t: "Y sé cuándo intentas hacer demasiado, que es cuando hay alguien mirando que te importa." },
          { m: "angry", t: "Así que la próxima vez no te va a salir tan fácil." },
          { m: "idle", t: "Pero te voy a pedir una cosa y va en serio, sin pique." },
          { m: "angry", t: "Estúdiame tú a mí." },
          { m: "idle", t: "Si esto va a ser una rivalidad de verdad, no pienso ser la única que hace los deberes." },
          { m: "angry", t: "Porque una rivalidad en la que solo uno de los dos se esfuerza no es una rivalidad. Es un fan club." },
          { m: "idle", t: "Y yo no soy tu fan." },
          { m: "celebracion", t: "Quiero que me obligues a cambiar. Ese es el trato entero." },
          { m: "angry", t: "Si tú subes, yo subo. Y si yo subo, tú no te puedes quedar quieto." },
          { m: "idle", t: "Así que vamos a subir el listón, ya que estamos." },
          { m: "angry", t: "Tu mejor nota hasta ahora la tengo apuntada. Sí, también apunto eso." },
          { m: "idle", t: "Quiero que la iguales o la superes. En un partido, el que sea." },
          { m: "angry", t: "Y quiero tres días bien hechos detrás. De los que no se ven." },
          { m: "idle", t: "Porque las notas buenas sueltas las tiene cualquiera un domingo que se levanta fino." },
          { m: "angry", t: "Las notas buenas repetidas hay que construirlas entre semana, y eso ya no lo hace todo el mundo." },
        ],
        replies: [
          { t: "¿Dónde puedo verte jugar?", m: "idle",
            r: [{ m: "angry", t: "…" }, { m: "idle", t: "Los domingos a las nueve y media. En un campo de tierra a las afueras." },
              { m: "angry", t: "No hay grada. Se ve de pie, desde detrás de una valla, con frío." },
              { m: "celebracion", t: "Y si vienes no me saludes, que me desconcentra." }] },
          { t: "Ya te estoy estudiando.", m: "idle",
            r: [{ m: "angry", t: "Mentira." }, { m: "idle", t: "…" }, { m: "angry", t: "¿Qué pie?" },
              { m: "celebracion", t: "Ajá. Ya. Eso pensaba." },
              { m: "idle", t: "Zurda. Apúntatelo, que te va a hacer falta." }] },
          { t: "¿Y si te supero?", m: "idle",
            r: [{ m: "angry", t: "Pues me superas." },
              { m: "idle", t: "Y yo tendré que hacer algo al respecto, que es exactamente para lo que sirve todo esto." },
              { m: "agotada", t: "Lo que no puedo permitirme es quedarme quieta viéndolo pasar." }] },
        ],
        snap: (g) => ({ since: todayStr(), matchCount: (g.matchHistory || []).length, bestRating: g.bestRating || 0 }),
        subs: [
        ...
        check: (g, s) => daysGoalsCompletedSince(g, s.since) >= 3 &&
          (g.matchHistory || []).slice(s.matchCount).some((m) => (m.rating || 0) >= s.bestRating) },
      /* CAPÍTULO 3 — La otra vida. Revela los turnos de noche: capítulo clave del DLC
         "Choque de clases". El rechazo de la ayuda económica no se suaviza. */
      { title: "La otra vida", zone: "discoteca",
        objective: "Consigue una victoria.",
        intro: [
          { m: "disco_happy", t: "Anda. Mira quién está aquí." },
          { m: "disco_seria", t: "Igualaste la nota. Lo vi el domingo por la noche, entre dos rondas." },
          { m: "disco_happy", t: "Y con los tres días. Los tres. Eso no lo esperaba, la verdad." },
          { m: "disco_seria", t: "…" },
          { m: "disco_happy", t: "Vale. Punto para ti. Dos a uno." },
          { m: "disco_happy", t: "Aunque el punto no es por la nota. El punto es por esto." },
          { m: "disco_happy", t: "Por haberme encontrado aquí." },
          { m: "disco_seria", t: "Trabajo aquí. Cuatro noches por semana, a veces cinco." },
          { m: "disco_happy", t: "Sí. Ya sé que no pega ni con cola con la imagen que te habías hecho de mí." },
          { m: "disco_seria", t: "Y antes de que digas nada: no es un rollo temporal ni un capricho." },
          { m: "disco_seria", t: "Es cómo pago el fútbol." },
          { m: "disco_happy", t: "¿Tú sabes lo que cuesta jugar donde juego yo?" },
          { m: "disco_seria", t: "Nada. No cuesta nada, esa es la broma. No cobro." },
          { m: "disco_seria", t: "Lo que cuesta es todo lo demás. Las botas. El fisio cuando algo suena raro. El autobús a los desplazamientos. El gimnasio." },
          { m: "disco_happy", t: "Y eso lo paga esta barra." },
          { m: "disco_seria", t: "Así que cuando te digo que quiero ganarte, no es solo pique." },
          { m: "disco_seria", t: "Es que cada partido mío ha costado un turno de noche." },
          { m: "disco_happy", t: "…Vale, se me está poniendo cara de discurso. Corto." },
          { m: "disco_happy", t: "En realidad este sitio tiene una ventaja enorme." },
          { m: "disco_seria", t: "En el campo todo el mundo sabe quién soy y qué se espera de mí." },
          { m: "disco_happy", t: "Aquí soy la chica que está trabajando esta noche." },
          { m: "disco_seria", t: "Nadie me pregunta cuánto he corrido ni quién ha ganado. Solo si la mesa quiere otra." },
          { m: "disco_happy", t: "Y algunas noches eso es exactamente lo que necesito." },
          { m: "disco_happy", t: "En fin. Que ahora sabes algo de mí que no sale cuando juego." },
          { m: "disco_seria", t: "Y una cosa importante, porque esto sí me importa." },
          { m: "disco_seria", t: "Aquí dentro no somos rivales." },
          { m: "disco_happy", t: "Al menos hasta que salgamos por esa puerta." },
          { m: "disco_happy", t: "Así que ahora vete a casa, que es tarde y mañana tienes entreno." },
          { m: "disco_seria", t: "Y gana el próximo. Uno cualquiera, no me pongo exquisita hoy." },
          { m: "disco_happy", t: "Porque quiero que la próxima vez que te vea aquí sea celebrando algo." },
          { m: "disco_seria", t: "Y no porque te hayas perdido buscando el baño." },
        ],
        replies: [
          { t: "Puedo ayudarte con eso.", m: "idle",
            r: [{ m: "disco_seria", t: "No." }, { m: "disco_seria", t: "…" },
              { m: "disco_happy", t: "Perdona. Ha salido más seco de lo que quería." },
              { m: "disco_seria", t: "Pero no. Ni ahora ni dentro de dos años cuando ganes diez veces más." },
              { m: "disco_happy", t: "Si alguien me paga el fútbol, deja de ser mío. Y es lo único que es mío entero." }] },
          { t: "No sabía nada de esto.", m: "idle",
            r: [{ m: "disco_happy", t: "Claro que no. No lo sabe casi nadie." },
              { m: "disco_seria", t: "En el campo no lo cuento. La gente empieza a mirarte distinto." },
              { m: "disco_seria", t: "Como si el turno explicara los malos partidos. Y no lo explica." },
              { m: "disco_happy", t: "Los malos partidos los explico yo, que para eso son míos." }] },
          { t: "Por eso siempre pareces cansada.", m: "idle",
            r: [{ m: "disco_seria", t: "…" }, { m: "disco_happy", t: "Vaya. Sí que te fijas." },
              { m: "disco_seria", t: "Sí. Por eso." },
              { m: "disco_happy", t: "Y ahora que lo sabes, no me lo menciones cada vez que me veas, porque me pondré insoportable." }] },
        ],
        setFlags: ["bekaDisco", "bekaTurnos"],
        snap: (g) => ({ since: todayStr(), matchCount: (g.matchHistory || []).length }),
        subs: [
          (g, s) => (g.matchHistory || []).slice(s.matchCount).some((m) => m.res === "V"),
        ],
        check: (g, s) => (g.matchHistory || []).slice(s.matchCount).some((m) => m.res === "V") },
      /* CAPÍTULO 4 — Las cuentas. Primer objeto (pulsera): revelado a mitad de escena. */
      { title: "Las cuentas", zone: "discoteca",
        objective: "Consigue 2 victorias.",
        introBefore: [
          { m: "disco_happy", t: "¿Has ganado?" },
          { m: "disco_happy", t: "Entonces hoy te puedes quedar." },
          { m: "disco_seria", t: "Lo digo en serio, es una norma de la casa: los que pierden se van pronto." },
          { m: "disco_happy", t: "Tres a uno, por cierto. Me he dado un punto porque yo también gané." },
          { m: "disco_seria", t: "Me gusta venir aquí después de jugar. Aunque me toque currar. Sobre todo si me toca currar." },
          { m: "disco_happy", t: "Durante unas horas nadie me pregunta por la clasificación ni por el próximo partido." },
          { m: "disco_seria", t: "Es raro, ¿sabes?" },
          { m: "disco_seria", t: "En el campo estoy todo el rato pensando en lo que viene después. En la jornada siguiente. En el mes que viene." },
          { m: "disco_happy", t: "Aquí puedo terminar una noche y ya está. Se acaba, cierro, me voy." },
          { m: "disco_seria", t: "Sin analizarla." },
          { m: "disco_happy", t: "…" },
          { m: "disco_happy", t: "Ya que has preguntado el otro día, te hago las cuentas y así dejas de mirarme con esa cara." },
          { m: "disco_seria", t: "Entreno cinco días. Juego uno. Trabajo cuatro noches." },
          { m: "disco_seria", t: "Los martes y los jueves salgo de aquí a las tres y a las siete y media estoy en el campo." },
          { m: "disco_happy", t: "Y sí, esos días juego peor. Bastante peor." },
          { m: "disco_seria", t: "Lo sé perfectamente y no puedo hacer nada al respecto, y esa es la parte que me come." },
          { m: "disco_seria", t: "Porque hay gente que juega en mi puesto y su único trabajo es jugar en mi puesto." },
          { m: "disco_happy", t: "No me quejo, ¿eh? Bueno, sí. Un poco. Es tarde y llevo ocho horas de pie." },
          ...
          { m: "disco_happy", t: "Toma. Antes de que se me olvide." },
          { m: "disco_seria", t: "Es la pulsera de personal. La de repuesto, no la mía, no te emociones." },
          { m: "disco_happy", t: "Con eso entras sin cola y sin pagar, cualquier noche." },
          { m: "disco_seria", t: "No es un regalo. Es logística." },
          { m: "disco_happy", t: "Es que me da una pereza infinita bajar a la puerta a buscarte cada vez." },
        ],
        introAfter: [
          { m: "disco_seria", t: "Bueno. Te voy a echar, que tengo que cerrar la caja." },
          { m: "disco_happy", t: "Pero antes, deberes." },
          { m: "disco_seria", t: "Dos victorias. No una. Dos." },
          { m: "disco_happy", t: "Y no es por pique." },
          { m: "disco_seria", t: "Es que ganar una vez es un buen día. Ganar dos seguidas ya es que tu equipo depende de ti." },
          { m: "disco_happy", t: "Y yo quiero saber si tu equipo depende de ti, porque el mío depende de mí y estoy sola en eso." },
          { m: "disco_seria", t: "Así que hazme compañía." },
        ],
        replies: [
          { t: "¿Cuándo duermes?", m: "idle",
            r: [{ m: "disco_happy", t: "Por la mañana. Entre el entreno y el turno." },
              { m: "disco_seria", t: "Cuatro horas y media, más o menos. Cinco los buenos días." },
              { m: "disco_happy", t: "Y ahora no me digas que eso no es sostenible, que ya lo sé." },
              { m: "disco_seria", t: "Lo sé desde hace dos años." }] },
          { t: "Yo también he dormido mal esta semana.", m: "idle",
            r: [{ m: "disco_seria", t: "…" }, { m: "disco_happy", t: "Vale, eso me ha gustado." },
              { m: "disco_happy", t: "Que no hayas dicho «qué duro» ni hayas puesto la cara." },
              { m: "disco_seria", t: "Cuéntame. En serio, cuéntame lo tuyo." }] },
          { t: "Gracias por la pulsera.", m: "happy",
            r: [{ m: "disco_seria", t: "He dicho que era logística." }, { m: "disco_happy", t: "…" },
              { m: "disco_happy", t: "De nada." }] },
        ],
        midReveal: "beka_pulsera",
        snap: (g) => ({ since: todayStr(), matchCount: (g.matchHistory || []).length }),
        subs: [
          { count: (g, s) => (g.matchHistory || []).slice(s.matchCount).filter((m) => m.res === "V").length, goal: 2 },
        ],
        check: (g, s) => (g.matchHistory || []).slice(s.matchCount).filter((m) => m.res === "V").length >= 2 },
      /* CAPÍTULO 5 — No todo es ganar. Primera grieta emocional (evento propio de Beka).
         Único capítulo hasta el 10 en el que el marcador no se menciona. */
      { title: "No todo es ganar", zone: "parque",
        objective: "Alcanza una racha de 3 días y cierra 3 días de objetivos.",
        intro: [
          { m: "idle", t: "Dos victorias." },
          { m: "idle", t: "Tu equipo depende de ti. Ya lo sabemos." },
          { m: "agotada", t: "…" },
          { m: "idle", t: "Perdona. Hoy vengo rara. No es por ti." },
          { m: "idle", t: "Hoy no te voy a retar. Relájate." },
          { m: "idle", t: "Bueno… inténtalo." },
          { m: "agotada", t: "El domingo perdimos 4-0." },
          { m: "idle", t: "Y no es eso. He perdido 4-0 muchas veces y me he ido a casa cantando." },
          { m: "agotada", t: "Lo que pasa es que al acabar me quedé sentada en el banquillo un rato largo. Sola, con la gente ya fuera." },
          { m: "agotada", t: "Y pensé: «¿por qué sigo haciendo esto?»" },
          { m: "idle", t: "Y tardé demasiado en contestarme." },
          { m: "angry", t: "Y eso no me había pasado nunca." },
          { m: "idle", t: "¿Sabes qué pasa cuando llevas mucho tiempo intentando demostrar algo?" },
          { m: "idle", t: "Que un día ya no sabes si juegas porque te gusta o porque te da pánico quedarte atrás." },
          { m: "agotada", t: "Al principio yo quería ganar porque me encantaba competir. De verdad. Era lo mejor de mi semana." },
          { m: "idle", t: "Luego empecé a pensar que si dejaba de ganar, alguien ocuparía mi sitio." },
          { m: "angry", t: "Y cuando piensas así, todo se convierte en una carrera. Todo." },
          { m: "agotada", t: "Los días que estás cansada. Los días que no te apetece. Los días que estás enferma." },
          { m: "angry", t: "Y ahí es donde competir deja de ser divertido y pasa a ser otra cosa." },
          { m: "idle", t: "No te estoy diciendo que aflojes. Nunca te voy a decir eso." },
          { m: "agotada", t: "Solo quiero acordarme de por qué empecé." },
          { m: "idle", t: "En fin. Que no he venido a deprimirte." },
          { m: "idle", t: "Vamos a hacer algo raro esta vez, y raro para mí quiere decir sin marcador." },
          { m: "angry", t: "Sin partidos. Sin notas. Sin nada que se pueda comparar." },
          { m: "idle", t: "Tres días seguidos cuidándote y tres días de objetivos cerrados." },
          { m: "agotada", t: "Y no lo hagas por mí ni para demostrarme nada, que es justo lo que llevo dos años haciendo mal." },
          { m: "idle", t: "Hazlo porque un día te vas a sentar solo en un banquillo después de perder 4-0." },
          { m: "angry", t: "Y ese día vas a necesitar tener algo debajo." },
        ],
        replies: [
          { t: "¿Por qué empezaste?", m: "idle",
            r: [{ m: "idle", t: "…" }, { m: "celebracion", t: "Porque se me daba bien y a nadie le parecía normal que se me diera bien." },
              { m: "angry", t: "Y esa cara que ponía la gente era lo mejor del mundo." },
              { m: "agotada", t: "Hace mucho que no la veo. Igual es eso." }] },
          { t: "¿Y el marcador?", m: "idle",
            r: [{ m: "idle", t: "Hoy no." }, { m: "agotada", t: "…" },
              { m: "idle", t: "Mañana sí. Hoy no me apetece contar nada." }] },
          { t: "A mí me pasa igual.", m: "idle",
            r: [{ m: "angry", t: "No me digas eso por decir." }, { m: "idle", t: "…" },
              { m: "agotada", t: "Vale. Perdona." },
              { m: "idle", t: "Si es verdad, es lo mejor que me han dicho en toda la semana." }] },
        ],
        setFlags: ["bekaGrieta"],
        snap: () => ({ since: todayStr() }),
        subs: [
      ...
      /* CAPÍTULO 6 — El sitio donde no me dejaron entrar. Reescrito por completo: siembra
         la ficha (el informe de la cantera), motor del personaje, pagada en el capítulo 12.
         No adelantar el contenido de la frase bajo ningún concepto. */
      { title: "El sitio donde no me dejaron entrar", zone: "ciudad-dep",
        objective: "Sube tu media (OVR) respecto al inicio del capítulo y cierra 4 días de objetivos.",
        intro: [
          { m: "idle", t: "Tres días. Los tres." },
          { m: "celebracion", t: "Y sin premio, sin marcador y sin nadie mirando." },
          { m: "angry", t: "Dos puntos. Te doy dos de golpe y no lo voy a explicar." },
          { m: "idle", t: "Tres a tres. Estamos empatados por primera vez." },
          { m: "angry", t: "No me gusta nada. Y me alegro muchísimo. Las dos cosas." },
          { m: "idle", t: "Así que esto es un centro de alto rendimiento." },
          { m: "angry", t: "No me mires, estoy mirando. Déjame mirar." },
          { m: "idle", t: "Es la primera vez que entro en uno." },
          { m: "agotada", t: "Bueno. La segunda." },
          { m: "idle", t: "…" },
          { m: "agotada", t: "Estuve en la cantera de un club grande. De los de verdad. Con dieciséis años." },
          { m: "angry", t: "Y no te hagas el sorprendido, que se me nota bastante que jugué en sitios buenos." },
          { m: "idle", t: "Estuve un año. Un año exacto, de agosto a agosto." },
          { m: "agotada", t: "Y en agosto me llamaron a un despacho como este, con estas mismas sillas horribles, y me dijeron que no seguía." },
          { m: "angry", t: "Y no fue por nivel. Eso es lo que me revienta hasta hoy." },
          { m: "idle", t: "El informe decía otra cosa. Una frase. Una frase de nada." },
          { m: "agotada", t: "Y llevo desde entonces discutiendo con esa frase." },
          { m: "angry", t: "Con un papel. Con un papel que firmó alguien que hoy no sabría ni decir mi nombre." },
          { m: "idle", t: "…" },
          { m: "angry", t: "Y ahora estoy aquí de invitada, mirando máquinas que nunca voy a usar, y me está dando una rabia que no te puedes imaginar." },
          { m: "agotada", t: "No contigo. Que quede clarísimo. Contigo nunca." },
          { m: "idle", t: "Es con la aritmética." },
          { m: "idle", t: "Tú vas a entrenar aquí. Yo voy a entrenar en un campo de tierra después de un turno." },
          { m: "angry", t: "Y aun así pienso alcanzarte. Esa es la parte divertida." },
          { m: "idle", t: "Bueno. Ya que estamos aquí y tú sí puedes usar todo esto, úsalo." },
          { m: "angry", t: "Y no me vengas con que te da apuro. Eso me ofendería de verdad." },
          { m: "idle", t: "Quiero ver tu media más alta que ahora. La miro antes de salir y la vuelvo a mirar dentro de unos días." },
          { m: "angry", t: "Y cuatro días cerrados por el medio." },
          { m: "celebracion", t: "Porque si tú subes, yo tengo que subir. Y me viene bien tener a alguien que me obligue." },
          { m: "idle", t: "Es lo único de todo esto que no depende del dinero de nadie." },
        ],
        replies: [
          { t: "¿Qué decía la frase?", m: "idle",
            r: [{ m: "angry", t: "No." }, { m: "idle", t: "…" }, { m: "agotada", t: "Hoy no." },
              { m: "idle", t: "Te la contaré algún día, cuando la frase me dé menos miedo que ahora." }] },
          { t: "Puedo colarte aquí.", m: "idle",
            r: [{ m: "celebracion", t: "…" }, { m: "angry", t: "Ni se te ocurra." },
              { m: "idle", t: "Si algún día entro por esa puerta, va a ser porque alguien me haya fichado." },
              { m: "angry", t: "No porque un amigo me haya abierto por detrás." },
              { m: "celebracion", t: "…Aunque ha sido bonito que se te ocurriera. Punto para ti. Mental. No cuenta." }] },
          { t: "Ese club se equivocó.", m: "idle",
            r: [{ m: "angry", t: "Ya." }, { m: "idle", t: "Eso lo dice todo el mundo." },
              { m: "agotada", t: "El problema es que da igual quién tenga razón cuando el que decide ya decidió." }] },
        ],
        setFlags: ["bekaCantera"],
        snap: (g) => ({ since: todayStr(), ovr: calcOVR(g.player.stats) }),
        subs: [
          (g, s) => calcOVR(g.player.stats) > s.ovr,
      ...
      /* CAPÍTULO 7 — La gente empieza a mirar. Escena de dos zonas (prensa → discoteca): el
         cambio de pose de idle/angry a disco_ marca el corte. */
      { title: "La gente empieza a mirar", zone: "prensa",
        objective: "Sube de categoría (o cambia de club) y juega al menos un partido con tu nuevo estado.",
        intro: [
          { m: "idle", t: "Subiste. Y con los cuatro días." },
          { m: "angry", t: "Un punto para ti, uno para mí. Yo también subí, para que lo sepas." },
          { m: "celebracion", t: "Cuatro a cuatro. Sigue siendo empate y sigue sin gustarme." },
          { m: "idle", t: "Te están empezando a reconocer por la calle." },
          { m: "angry", t: "No te emociones." },
          { m: "idle", t: "La gente te mira cuando ganas y opina cuando pierdes. Esas son las dos cosas que hace la gente." },
          { m: "idle", t: "Yo llevo un poco más de tiempo sabiendo cómo funciona esto. Y en una escala mucho más pequeña, que la mía es de barrio." },
          { m: "angry", t: "Primero te gusta que te reconozcan. Y está bien que te guste, es normal." },
          { m: "idle", t: "Después empiezas a pensar en lo que esperan de ti." },
          { m: "idle", t: "Y entonces cada partido pesa un poco más que el anterior." },
          { m: "agotada", t: "A mí me pasó a los diecisiete, cuando salí de la cantera y volví al barrio." },
          { m: "agotada", t: "Todo el mundo sabía que había estado allí y todo el mundo sabía que me habían echado." },
          { m: "angry", t: "Y jugaba cada domingo con veinte personas mirándome pensando «a ver si es verdad que era buena»." },
          { m: "idle", t: "Veinte personas. Imagínate cuarenta mil." },
          { m: "idle", t: "No quiero que te pase lo mismo que a mí. Aunque probablemente te va a pasar igual." },
          { m: "disco_seria", t: "Así que si algún día te pesa, ven aquí." },
          { m: "disco_seria", t: "Aquí nadie te va a preguntar por la rueda de prensa." },
          { m: "disco_happy", t: "Pero no esperes que te deje ganar. Eso no." },
          { m: "disco_seria", t: "Y ahora, deberes, que si no esto se convierte en terapia." },
          { m: "disco_happy", t: "Sube de categoría." },
          { m: "disco_seria", t: "El siguiente escalón, el que sea. Y después juega ya siendo ese jugador." },
          { m: "disco_happy", t: "No el que acaba de llegar y va con cuidado para no molestar." },
          { m: "disco_seria", t: "Porque la gente te va a mirar igual estés donde estés." },
          { m: "disco_happy", t: "Así que mejor que te miren desde más arriba, ¿no?" },
        ],
        replies: [
          { t: "¿Cómo lo llevaste tú?", m: "idle",
            r: [{ m: "disco_seria", t: "Mal. Muy mal, el primer año." },
              { m: "disco_happy", t: "Jugaba para callar bocas y jugando para callar bocas se juega fatal." },
              { m: "disco_seria", t: "Tardé dos temporadas en volver a jugar para mí." },
              { m: "disco_happy", t: "Ojalá tardes menos. Es un consejo gratis y no te doy muchos." }] },
          { t: "Tú nunca me preguntas por eso.", m: "idle",
            r: [{ m: "disco_happy", t: "Porque no me interesa." }, { m: "disco_seria", t: "…" },
              { m: "disco_seria", t: "Vale, sí me interesa. Pero no es lo que quiero de ti." },
              { m: "disco_happy", t: "Hay cuarenta mil personas para preguntarte eso. Yo hago la otra parte." }] },
          { t: "Ven a un partido mío.", m: "idle",
            r: [{ m: "disco_seria", t: "Voy a todos los que puedo." }, { m: "disco_happy", t: "…" },
              { m: "disco_seria", t: "No lo digas en voz alta que me arrepiento." }] },
        ],
        snap: (g) => ({ since: todayStr(), tierId: g.tier.id, clubName: g.club && g.club.name, matchCount: (g.matchHistory || []).length }),
        subs: [
          (g, s) => g.tier.id > s.tierId || (g.club && g.club.name) !== s.clubName,
        ...
        check: (g, s) => (g.tier.id > s.tierId || (g.club && g.club.name) !== s.clubName) &&
          (g.matchHistory || []).slice(s.matchCount).length >= 1 },
      /* CAPÍTULO 8 — Una noche sin fútbol. Punto de inflexión: ya no es solo rivalidad. */
      { title: "Una noche sin fútbol", zone: "discoteca",
        objective: "Cierra 2 días de objetivos y consigue una victoria.",
        intro: [
          { m: "disco_happy", t: "Categoría nueva." },
          { m: "disco_seria", t: "Lo vi anunciado el jueves. Me pilló aquí, sirviendo." },
          { m: "disco_happy", t: "Y me quedé con la botella en la mano como una idiota mirando el móvil." },
          { m: "disco_seria", t: "El de la mesa cuatro sigue esperando su copa, probablemente." },
          { m: "disco_happy", t: "Hoy tenemos una regla. Una." },
          { m: "disco_seria", t: "No hablamos de fútbol." },
          { m: "disco_happy", t: "Una noche. Puedes sobrevivir, te lo prometo." },
          { m: "disco_happy", t: "Podemos hablar de música. De comida. De cosas absurdas que no tengan nada que ver con nuestras carreras." },
          { m: "disco_seria", t: "Y si mencionas tu próximo partido, te vas. Lo digo completamente en serio." },
          { m: "disco_happy", t: "…" },
          { m: "disco_seria", t: "Te cuento por qué, para que no parezca un capricho." },
          { m: "disco_seria", t: "Llevo ocho años hablando de fútbol con absolutamente todo el mundo." },
          { m: "disco_seria", t: "Con mi madre. Con mis amigas. Con la gente que conozco aquí a las dos de la mañana." },
          { m: "disco_happy", t: "Y en algún momento me di cuenta de que si me quitas el fútbol, no sé de qué hablo." },
          { m: "disco_seria", t: "Que es una cosa bastante triste de descubrir sobre ti misma un martes cualquiera." },
          { m: "disco_happy", t: "Así que estoy practicando." },
          { m: "disco_seria", t: "Y me estoy sirviendo de ti, que eres el único al que puedo decírselo sin que se preocupe." },
          { m: "disco_seria", t: "…" },
          { m: "disco_seria", t: "Y es raro, ¿sabes?" },
          { m: "disco_seria", t: "Contigo puedo estar aquí y no pensar en quién es mejor." },
          { m: "disco_happy", t: "Eso no significa que vaya a dejar de intentar ganarte, que conste." },
          { m: "disco_seria", t: "Solo significa que ahora hay cosas que me importan además de eso." },
          { m: "disco_happy", t: "Y no, no voy a hacer una lista. No preguntes." },
          { m: "disco_seria", t: "Bueno, y ahora rompo mi propia norma en el último minuto, que es muy propio de mí." },
          { m: "disco_happy", t: "Dos días. Solo dos. Cerrados bien." },
          { m: "disco_seria", t: "Y una victoria cuando toque, sin prisa." },
          { m: "disco_happy", t: "Es poco a propósito, no te acostumbres." },
          { m: "disco_seria", t: "Es que hoy no quería pedirte nada grande." },
          { m: "disco_happy", t: "Supongo que ya no eres solo el tío al que quiero ganar." },
          { m: "disco_seria", t: "Y no. No preguntes qué significa eso." },
        ],
        replies: [
          { t: "¿Qué música te gusta?", m: "idle",
            r: [{ m: "disco_happy", t: "Nada de lo que suena aquí." },
              { m: "disco_seria", t: "Aquí pongo lo que pide la gente. Lo mío lo escucho a las cuatro de la mañana volviendo a casa andando." },
              { m: "disco_happy", t: "Y no te lo voy a decir porque te vas a reír." },
              { m: "disco_seria", t: "…Es todo muy tranquilo. Ya está. Ya lo he dicho. No comentes." }] },
          { t: "Yo tampoco sé de qué hablar sin fútbol.", m: "idle",
            r: [{ m: "disco_seria", t: "…" }, { m: "disco_happy", t: "Menos mal." },
              { m: "disco_seria", t: "Llevo diez minutos aterrorizada pensando que era la única." },
              { m: "disco_happy", t: "Vale. Pues aprendemos los dos. Peor no lo vamos a hacer." }] },
          { t: "Has dicho «fútbol» tres veces ya.", m: "idle",
            r: [{ m: "disco_seria", t: "…" }, { m: "disco_happy", t: "Cállate." }, { m: "disco_happy", t: "Cállate ahora mismo." },
              { m: "disco_seria", t: "…Vale, punto para ti. Y no lo digo en voz alta pero está apuntado." }] },
        ],
        setFlags: ["bekaClose"],
        snap: (g) => ({ since: todayStr(), matchCount: (g.matchHistory || []).length }),
        subs: [
        ...
        check: (g, s) => daysGoalsCompletedSince(g, s.since) >= 2 &&
          (g.matchHistory || []).slice(s.matchCount).some((m) => m.res === "V") },
      /* CAPÍTULO 9 — La aritmética. REGLA: los celos de Beka no son románticos ni
         personales: el conflicto es material, y absuelve al jugador dos veces en la
         misma escena. */
      { title: "La aritmética", zone: "barrio",
        objective: "Sube tu media (OVR) al menos 2 puntos por encima de la del inicio del capítulo.",
        intro: [
          { m: "idle", t: "Ganaste. Y cerraste los dos días." },
          { m: "idle", t: "Dos puntos. Cuatro a siete." },
          { m: "agotada", t: "…" },
          { m: "angry", t: "Sí. Voy perdiendo. Por primera vez desde que existe esto." },
          { m: "idle", t: "Así que has subido otra vez. Enhorabuena, de verdad." },
          { m: "angry", t: "Ya está. Se acabó la ceremonia." },
          { m: "idle", t: "…" },
          { m: "agotada", t: "Ahora la parte que llevo tres días ensayando y que no me sale." },
          { m: "agotada", t: "Parece que corres más rápido que yo. Y no me refiero al campo." },
          { m: "idle", t: "Este mes tú has entrenado en pista cubierta con un preparador que te corrige el gesto." },
          { m: "idle", t: "Yo he entrenado seis veces en un campo encharcado y dos las he tenido que dejar a la media hora porque venía de currar." },
          { m: "angry", t: "Y no. No es culpa tuya. Ni un poco." },
          { m: "angry", t: "Tú no has hecho nada más que lo que yo te he estado pidiendo desde el primer día." },
          { m: "agotada", t: "Es la aritmética otra vez. Es que las horas no dan." },
          { m: "idle", t: "Antes podía pensar que si tú mejorabas, yo simplemente tendría que alcanzarte y ya está." },
          { m: "agotada", t: "Ahora tengo la sensación de que la distancia crece sola, aunque yo no pare." },
          { m: "angry", t: "Y eso me pone de un humor horrible." },
          { m: "idle", t: "No contigo." },
          { m: "angry", t: "Conmigo. Siempre conmigo." },
          { m: "agotada", t: "Porque no quiero que todo esto acabe siendo yo persiguiéndote desde atrás y tú frenando para que no se note." },
          { m: "idle", t: "Prefiero perder de lejos a que me dejes ganar de cerca." },
          { m: "angry", t: "Así que voy a hacer lo que sé hacer. Voy a apretar más." },
          { m: "idle", t: "Y esta vez no quiero que me esperes." },
          { m: "idle", t: "Así que te voy a pedir algo egoísta y prefiero avisarte de que es egoísta." },
          { m: "angry", t: "Sigue subiendo. No pares por mí." },
          { m: "idle", t: "Quiero ver tu media dos puntos por encima de donde está hoy." },
          { m: "angry", t: "Dos. No uno. Dos." },
          { m: "agotada", t: "Porque necesito saber cuánto tengo que correr." },
          { m: "idle", t: "Y si me quedo atrás, prefiero enterarme ahora y no dentro de dos temporadas." },
          { m: "angry", t: "Prefiero un número que una duda. Siempre." },
        ],
        replies: [
          { t: "Podría pagarte un preparador.", m: "idle",
            r: [{ m: "angry", t: "No." }, { m: "angry", t: "Ya te lo dije en la barra y te lo digo aquí." },
              { m: "agotada", t: "Y no es orgullo, o no es solo orgullo." },
              { m: "idle", t: "Es que si me lo pagas tú, cuando te gane no voy a saber si te he ganado yo." },
              { m: "angry", t: "Y necesito saberlo. Es lo único que necesito de verdad." }] },
          { t: "Yo no estoy frenando.", m: "idle",
            r: [{ m: "idle", t: "Ya lo sé." }, { m: "celebracion", t: "Y por eso sigues aquí." },
              { m: "angry", t: "El día que frenes, se acaba esto. Sin drama y sin discusión. Se acaba." }] },
          { t: "Entonces alcánzame.", m: "angry",
            r: [{ m: "angry", t: "…" }, { m: "celebracion", t: "Eso. Eso es exactamente lo que necesitaba oír." },
              { m: "angry", t: "Ni una palabra de ánimo. Un reto." },
              { m: "celebracion", t: "Punto para ti. Cuatro a ocho. Y ha valido la pena." }] },
        ],
        setFlags: ["bekaDistancia"],
        snap: (g) => ({ since: todayStr(), ovr: calcOVR(g.player.stats) }),
        subs: [
          (g, s) => calcOVR(g.player.stats) >= s.ovr + 2,
        ],
        check: (g, s) => calcOVR(g.player.stats) >= s.ovr + 2 },
      /* CAPÍTULO 10 — No necesito que me salves. CRISIS PRINCIPAL: la lesión es un evento
         de escena de Beka, nunca del jugador. Única vez que acepta ayuda, con tres
         condiciones intactas. El marcador se congela aquí, en voz alta. */
      { title: "No necesito que me salves", zone: "enfermeria",
        objective: "Recupera una forma de 'buen' o 'alza', cierra 3 días de objetivos y consigue una victoria.",
        intro: [
          { m: "agotada", t: "Dos puntos. Los has subido." },
          { m: "agotada", t: "Lo vi el lunes." },
          { m: "angry", t: "No, no te voy a dar el punto." },
          { m: "agotada", t: "Hoy no. Hoy no me apetece contar nada y ya está." },
          { m: "agotada", t: "Estoy bien." },
          { m: "agotada", t: "Deja de mirarme así." },
          { m: "angry", t: "No necesito que me salves. Necesito seguir." },
          { m: "agotada", t: "Ha sido el sóleo. O el gemelo. El fisio de aquí dice una cosa y el chico que me miró en el barrio decía otra." },
          { m: "angry", t: "Y el del barrio me lo miró gratis en un vestuario, así que igual el margen de error es mayor. Ya." },
          { m: "idle", t: "…" },
          { m: "agotada", t: "Llevo cinco semanas entrenando con molestias y no se lo he dicho a nadie." },
          { m: "angry", t: "Porque si paro, siento que todo el mundo me adelanta." },
          { m: "agotada", t: "Y porque parar significa no trabajar, y no trabajar significa no pagar el mes." },
          { m: "idle", t: "Y no pienso volver a empezar desde abajo. Ya empecé desde abajo una vez, con dieciséis años y un papel en la mano." },
          { m: "angry", t: "Ya sé que suena mal dicho así de seguido." },
          { m: "agotada", t: "Y también sé que no puedo apretar cada vez que tengo miedo, porque llevo dos años haciéndolo y mira dónde estoy." },
          { m: "idle", t: "Pero cuando llevas tanto tiempo construyendo algo con las manos, parar se parece mucho a perderlo." },
          { m: "angry", t: "No me mires como si estuviera rota." },
          { m: "agotada", t: "Quiero volver a estar bien. Nada más." },
          { m: "idle", t: "Y si para eso tengo que aceptar que hoy no puedo con todo, pues supongo que tendré que aceptarlo." },
          { m: "angry", t: "Pero no me conviertas en un proyecto tuyo." },
          { m: "idle", t: "Ayúdame solo a acordarme de que descansar también es seguir." },
          { m: "idle", t: "Vale. Vamos a hacer una cosa y no me la discutas, que hoy no tengo fuerzas." },
          { m: "angry", t: "Yo paro unos días. Tú no." },
          { m: "idle", t: "Tú vas a hacer exactamente lo que yo no he sabido hacer en dos años." },
          { m: "angry", t: "Vuelve a estar bien. En condiciones. Que se te note en la forma." },
          { m: "idle", t: "Tres días cerrados y una victoria, sin apretar de más y sin hacer el héroe." },
          { m: "agotada", t: "Y quiero verlo. Necesito ver a alguien haciéndolo bien para creerme que se puede." },
          { m: "angry", t: "Y no lo apuntes en el marcador." },
          { m: "idle", t: "Esto no es un punto. Esto es otra cosa." },
        ],
        replies: [
          { t: "Déjame pagarte el fisio. Solo eso.", m: "idle",
            r: [{ m: "angry", t: "…" }, { m: "agotada", t: "…" },
              { m: "idle", t: "Las sesiones. Solo las sesiones. No el mes, no el gimnasio, no las botas." },
              { m: "angry", t: "Y te las devuelvo. Con un plazo. Y lo apuntamos." },
              { m: "agotada", t: "Y si alguna vez me lo echas en cara, se acabó." },
              { m: "idle", t: "…Gracias. Odio decirlo y lo digo." }] },
          { t: "Coge la baja una semana.", m: "idle",
            r: [{ m: "angry", t: "No puedo." }, { m: "idle", t: "…" }, { m: "agotada", t: "Puedo tres días. Tres." },
              { m: "angry", t: "Y ya me parece una barbaridad, así que no negocies más." }] },
          { t: "Ya has demostrado bastante.", m: "idle",
            r: [{ m: "angry", t: "¿A quién?" }, { m: "idle", t: "…" },
              { m: "agotada", t: "Esa es justo la pregunta que llevo ocho años sin contestarme." },
              { m: "idle", t: "Y creo que ese es el problema entero." }] },
        ],
        setFlags: ["bekaCrisis"],
        snap: (g) => ({ since: todayStr(), matchCount: (g.matchHistory || []).length }),
        subs: [
        ...
        check: (g, s) => Object.entries(g.logs || {}).some(([d, l]) => d >= s.since && l.closed && (l.form === "buen" || l.form === "alza")) &&
          daysGoalsCompletedSince(g, s.since) >= 3 && (g.matchHistory || []).slice(s.matchCount).some((m) => m.res === "V") },
      /* CAPÍTULO 11 — El día que ninguno trabajaba. ÚNICO CAMBIO DE ZONA de la campaña
         (discoteca → playa en la 2.0), y único capítulo escrito íntegramente con la pose
         playa, que hasta ahora no se usaba en ningún capítulo. */
      { title: "El día que ninguno trabajaba", zone: "playa",
        objective: "Cierra 2 días completos: entrenamiento, comida y sueño el mismo día.",
        intro: [
          { m: "playa", t: "Lo hiciste." },
          { m: "playa", t: "Tres días, forma decente y un partido ganado sin forzar nada." },
          { m: "playa", t: "Y yo paré cuatro días, que para mí es una eternidad." },
          { m: "playa", t: "Y no se ha hundido nada. Sigue todo en su sitio. Qué rabia y qué alivio." },
          { m: "playa", t: "Vale, antes de nada: yo no vengo a la playa. Nunca." },
          { m: "playa", t: "En verano trabajo más noches porque hay más gente, así que agosto para mí es el mes en que menos vida hago." },
          { m: "playa", t: "Así que esto es raro. Esto es rarísimo." },
          { m: "playa", t: "Hoy es martes. Y es la primera vez en dos años que un martes no tengo nada que hacer." },
          { m: "playa", t: "Ni turno. Ni entreno, porque estoy parando. Ni partido." },
          { m: "playa", t: "Y he tardado como cuarenta minutos en decidir qué hacía, porque no tenía ni idea." },
          { m: "playa", t: "Al final he pensado: llamo al único que también vive así." },
          { m: "playa", t: "…" },
          { m: "playa", t: "¿Te has dado cuenta de que es la primera vez que quedamos sin que ninguno de los dos esté trabajando?" },
          { m: "playa", t: "En el campo tú estás trabajando. En la barra yo estoy trabajando." },
          { m: "playa", t: "Hasta cuando hablamos de nuestras cosas, hay una barra en medio o hay un partido esa semana." },
          { m: "playa", t: "Hoy no hay nada. Y me está costando un montón, si te soy sincera." },
          { m: "playa", t: "No sé qué hacer con las manos." },
          { m: "playa", t: "…" },
          { m: "playa", t: "Ah, y otra cosa. He mirado el móvil antes de venir para saber cómo íbamos en el marcador." },
          { m: "playa", t: "Y no me acordaba. He tenido que buscarlo." },
          { m: "playa", t: "Eso no me había pasado nunca." },
          { m: "playa", t: "Bueno, y ahora la parte en la que te pido algo, que es lo que hago siempre y no lo voy a cambiar hoy." },
          { m: "playa", t: "Pero es distinto esta vez." },
          { m: "playa", t: "No quiero ni una victoria, ni una nota, ni un punto de media." },
          { m: "playa", t: "Quiero dos días enteros. De los completos: entreno, comida y sueño. Los tres, el mismo día, dos veces." },
          { m: "playa", t: "Y ya sé que suena a poco comparado con lo que te pido normalmente." },
          { m: "playa", t: "Es que llevo dos años sin conseguir juntar los tres el mismo día ni una sola vez." },
          { m: "playa", t: "Así que para mí no es poco. Para mí es lo más difícil que te he pedido nunca." },
        ],
        replies: [
          { t: "¿Y cómo vamos?", m: "idle",
            r: [{ m: "playa", t: "No te lo voy a decir." }, { m: "playa", t: "…" },
              { m: "playa", t: "Vale, sí: vas ganando y de lejos." },
              { m: "playa", t: "Y lo raro es que no me ha dado el bajón que esperaba." },
              { m: "playa", t: "Llevo desde el jueves esperando el bajón y no ha venido." }] },
          { t: "¿Qué harías si no jugaras?", m: "idle",
            r: [{ m: "playa", t: "…" }, { m: "playa", t: "No lo sé." },
              { m: "playa", t: "Y esa es la respuesta que me da miedo, no la pregunta." },
              { m: "playa", t: "Tengo veintitrés años y no sé contestarte a eso. Eso no puede estar bien." }] },
          { t: "Yo tampoco sé qué hacer con las manos.", m: "idle",
            r: [{ m: "playa", t: "Menos mal." }, { m: "playa", t: "Pensaba que era la única que no sabe estar quieta." },
              { m: "playa", t: "Bueno. Pues estamos los dos aquí sin saber. Es un plan." }] },
        ],
        setFlags: ["bekaTrust"],
        snap: () => ({ since: todayStr() }),
        subs: [
          { count: (g, s) => proteinSleepDaysSince(g, s.since), goal: 2 },
          { count: (g, s) => Object.entries(g.logs || {}).filter(([d, l]) => d >= s.since && l.closed && l.gym).length, goal: 2 },
        ],
        check: (g, s) => proteinSleepDaysSince(g, s.since) >= 2 &&
          Object.entries(g.logs || {}).filter(([d, l]) => d >= s.since && l.closed && l.gym).length >= 2 },
      /* CAPÍTULO 12 — La frase. PICO EMOCIONAL: se paga la siembra del capítulo 6. La
         frase «No reúne el perfil competitivo requerido» se lee una única vez, y debe
         quedar exactamente así. */
      { title: "La frase", zone: "parque",
        objective: "Cierra 3 días completos (entrenamiento, comida y sueño) y gana el siguiente partido.",
        intro: [
          { m: "idle", t: "Dos días completos. Los tres marcadores, el mismo día, dos veces." },
          { m: "celebracion", t: "¿Sabes que eso es más difícil que ganar un partido?" },
          { m: "idle", t: "Nadie te aplaude por eso. Nadie se entera." },
          { m: "agotada", t: "Yo me he enterado." },
          { m: "idle", t: "Hoy quería preguntarte una cosa y llevo toda la semana buscando cómo." },
          { m: "idle", t: "¿Tú también tienes miedo?" },
          { m: "idle", t: "De quedarte atrás. De que todo esto acabe siendo demasiado." },
          { m: "agotada", t: "Yo sí." },
          { m: "idle", t: "A veces miro lo lejos que hemos llegado los dos y pienso que debería estar disfrutándolo mucho más de lo que lo disfruto." },
          { m: "agotada", t: "Y en vez de eso una parte de mí sigue pensando en lo que falta." },
          { m: "idle", t: "El siguiente partido. El siguiente nivel. La siguiente temporada." },
          { m: "angry", t: "Supongo que por eso seguimos, ¿no?" },
          { m: "idle", t: "Porque si dejamos de correr aparece la pregunta de qué queda cuando ya no hay nada que perseguir." },
          { m: "agotada", t: "Y yo todavía no sé contestarla." },
          { m: "idle", t: "…" },
          { m: "idle", t: "Mira. Te voy a enseñar una cosa que no le he enseñado a nadie." },
          { m: "agotada", t: "Está en la cartera. Doblada en cuatro. Llevo siete años cambiándola de cartera." },
          { m: "idle", t: "Es la fotocopia del informe. El de la cantera, el de agosto." },
          { m: "agotada", t: "Y la frase es esta. La de abajo, la subrayada." },
          { m: "agotada", t: "«No reúne el perfil competitivo requerido»." },
          { m: "angry", t: "Yo. Que no reúno el perfil competitivo." },
          { m: "idle", t: "Ocho palabras. Ocho. Y llevo siete años organizando mi vida alrededor de ocho palabras que escribió alguien en veinte segundos." },
          { m: "agotada", t: "Y lo peor no es que me doliera." },
          { m: "agotada", t: "Lo peor es que funcionó. Que soy quien soy por esa frase, y no sé cuánto de mí es mío y cuánto es la respuesta a un papel." },
          { m: "idle", t: "Pero creo que es más fácil de llevar cuando hay alguien que entiende lo mismo." },
          { m: "angry", t: "No te pongas sentimental." },
          { m: "idle", t: "Solo estoy diciendo que quizá no estamos tan solos como pensábamos." },
          { m: "idle", t: "Bueno. Vamos a andar un rato, que si nos quedamos aquí sentados esto se pone peor." },
          { m: "idle", t: "Y te voy a pedir la última cosa difícil, porque a partir de aquí ya solo quedan cosas bonitas." },
          { m: "angry", t: "Tres días completos. Entreno, comida y sueño, los tres, tres veces." },
          { m: "idle", t: "Uno más que la última vez. Solo uno." },
          { m: "agotada", t: "Es que ese es exactamente el sitio donde yo siempre me caigo. Al tercero." },
          { m: "idle", t: "Y quiero ver si el tercero existe o si es una excusa que llevo dos años contándome." },
          { m: "angry", t: "Y gana el siguiente partido, ya que estás." },
          { m: "celebracion", t: "Que no todo va a ser terapia." },
        ],
        replies: [
          { t: "Yo también tengo miedo.", m: "idle",
            r: [{ m: "idle", t: "…" }, { m: "celebracion", t: "Vale." }, { m: "idle", t: "Entonces no soy la única." },
              { m: "angry", t: "Eso no significa que vaya a aflojar, ¿eh?" },
              { m: "idle", t: "Pero sí significa que ahora sé por qué sigo." }] },
          { t: "Rómpela.", m: "angry",
            r: [{ m: "angry", t: "…" }, { m: "idle", t: "No puedo." }, { m: "agotada", t: "Hoy no puedo." },
              { m: "idle", t: "Pero es la primera vez que alguien me lo dice y no me parece una tontería." },
              { m: "idle", t: "Dame tiempo." }] },
          { t: "Tenían razón. No reunías el perfil. Reunías otro mejor.", m: "idle",
            r: [{ m: "angry", t: "…" }, { m: "agotada", t: "No hagas eso." }, { m: "idle", t: "…" },
              { m: "celebracion", t: "Vale, ha estado bien. Ha estado muy bien." },
              { m: "angry", t: "Pero no lo repitas, que me pongo tonta." }] },
        ],
        setFlags: ["bekaFicha"],
        snap: (g) => ({ since: todayStr(), matchCount: (g.matchHistory || []).length }),
        subs: [
          { count: (g, s) => proteinSleepDaysSince(g, s.since), goal: 3 },
          { count: (g, s) => Object.entries(g.logs || {}).filter(([d, l]) => d >= s.since && l.closed && l.gym).length, goal: 3 },
          (g, s) => (g.matchHistory || []).slice(s.matchCount).some((m) => m.res === "V"),
        ],
        check: (g, s) => proteinSleepDaysSince(g, s.since) >= 3 &&
          Object.entries(g.logs || {}).filter(([d, l]) => d >= s.since && l.closed && l.gym).length >= 3 &&
          (g.matchHistory || []).slice(s.matchCount).some((m) => m.res === "V") },
      /* CAPÍTULO 13 — Caminos distintos. «Yo hasta ahí no voy a llegar» no se suaviza: es
         el precio real del choque de clases. */
      { title: "Caminos distintos", zone: "estadio",
        objective: "Alcanza la categoría Europa y gana un partido por dos goles de diferencia o más.",
        intro: [
          { m: "celebracion", t: "Tres días completos. El tercero existía." },
          { m: "idle", t: "Te lo dije: ahí es donde me caigo yo siempre." },
          { m: "agotada", t: "Y ahora ya sé que no era una excusa. Que se puede." },
          { m: "angry", t: "Lo cual es peor para mí, evidentemente. Muchas gracias." },
          { m: "idle", t: "Mírate. Y mira esto." },
          { m: "idle", t: "Cuando te conocí estabas en Tercera y yo venía de un turno de noche a verte a un campo municipal." },
          { m: "celebracion", t: "Ahora estás aquí." },
          { m: "idle", t: "Y yo he llegado más lejos de lo que pensaba, aunque no tan lejos como tú, y ya no me importa decirlo en voz alta." },
          { m: "idle", t: "Lo curioso es que durante mucho tiempo pensé que el objetivo de todo esto era acabar los dos en el mismo sitio." },
          { m: "idle", t: "Como si la meta fuera empatar." },
          { m: "agotada", t: "Y estuve a punto de amargarme cuando vi que no iba a pasar." },
          { m: "idle", t: "Ahora creo que no. Creo que el sitio nunca era el punto." },
          { m: "celebracion", t: "Ninguno de los dos se quedó esperando al otro. Eso es lo que me gusta de nuestra historia." },
          { m: "idle", t: "Tú seguiste tu camino. Yo seguí el mío, que ha sido más largo y con menos luz." },
          { m: "celebracion", t: "Y aun así seguimos encontrándonos. Cada mes. Sin faltar uno." },
          { m: "idle", t: "Eso es bastante más difícil que competir. Competir lo hace cualquiera." },
          { m: "angry", t: "Y por cierto, ni idea de cómo vamos en el marcador." },
          { m: "idle", t: "Ni idea. Y no lo he mirado." },
          { m: "celebracion", t: "Así que disfruta esto. Míralo bien, que se pasa rápido." },
          { m: "angry", t: "Porque todavía quiero ver hasta dónde llegas." },
          { m: "idle", t: "Y ya que estamos en el sitio bonito, te pido algo del sitio bonito." },
          { m: "celebracion", t: "Quiero verte en Europa." },
          { m: "angry", t: "Sí, Europa. Lo he dicho y no me voy a echar atrás." },
          { m: "idle", t: "Y quiero que llegues ganando, no de rebote y no de milagro." },
          { m: "idle", t: "Una victoria buena, de las que se ganan por dos." },
          { m: "agotada", t: "Porque yo hasta ahí no voy a llegar. Ya lo sé y lo he asumido esta temporada." },
          { m: "celebracion", t: "Así que quiero llegar de la otra manera. Mirándolo desde aquí." },
        ],
        replies: [
          { t: "Podrías estar aquí tú.", m: "idle",
            r: [{ m: "idle", t: "Podría." }, { m: "agotada", t: "Con otro nacimiento, otra cartera y otro agosto de hace siete años, podría." },
              { m: "celebracion", t: "Pero entonces no te habría conocido a ti en un campo de tierra." },
              { m: "angry", t: "Y eso, mira, no lo cambio." }] },
          { t: "¿Sigues queriendo ganarme?", m: "idle",
            r: [{ m: "celebracion", t: "Siempre." }, { m: "angry", t: "Hasta el último día." },
              { m: "idle", t: "Lo que ha cambiado es que ya no necesito ganarte para estar bien." },
              { m: "celebracion", t: "Que es distinto y me ha costado un año entenderlo." }] },
          { t: "Gracias por venir a todos.", m: "happy",
            r: [{ m: "angry", t: "No he venido a todos." }, { m: "idle", t: "…" },
              { m: "agotada", t: "He venido a todos los que he podido, que no es lo mismo y me fastidia bastante." },
              { m: "celebracion", t: "A este he cambiado el turno. Así que este cuenta doble." }] },
        ],
        snap: (g) => ({ since: todayStr(), matchCount: (g.matchHistory || []).length }),
        subs: [
          (g) => g.tier.id >= 5,
        ...
        check: (g, s) => g.tier.id >= 5 &&
          (g.matchHistory || []).slice(s.matchCount).some((m) => m.res === "V" && (m.gf || 0) - (m.ga || 0) >= 2) },
      /* CAPÍTULO 14 — Todavía no he terminado. Aquí muere el marcador oficialmente: nació
         en C1, se rompió en C10, se olvidó en C11 y se entierra aquí. */
      { title: "Todavía no he terminado", zone: "discoteca",
        objective: "Cierra 5 días de objetivos.",
        intro: [
          { m: "disco_happy", t: "Europa." },
          { m: "disco_seria", t: "Y ganando por dos, como te pedí." },
          { m: "disco_happy", t: "Y sí, lo vi. Desde aquí, en la tele de encima de la barra, con el sonido quitado y subtítulos." },
          { m: "disco_seria", t: "La mejor forma de ver un partido, por cierto. No opines." },
          { m: "disco_happy", t: "Hola, por cierto. Cuánto tiempo." },
          { m: "disco_seria", t: "He estado ocupada. Entrenando, jugando, intentando construir lo mío." },
          { m: "disco_happy", t: "Y no, no te voy a contar todo." },
          { m: "disco_seria", t: "Han pasado cosas. Cosas buenas, algunas. Y algunas quiero conseguirlas yo sola antes de contarlas." },
          { m: "disco_happy", t: "No es desconfianza. Es que si te lo cuento ahora, cuando salga bien va a ser un poco tuyo." },
          { m: "disco_seria", t: "Y necesito una que sea entera mía." },
          { m: "disco_happy", t: "…" },
          { m: "disco_seria", t: "Antes yo confundía estar cerca de alguien con necesitar saberlo todo de esa persona." },
          { m: "disco_seria", t: "Y con necesitar medirme con ella cada semana." },
          { m: "disco_happy", t: "Ahora no." },
          { m: "disco_seria", t: "Puedo alegrarme de que te vaya bien sin saber exactamente qué estás haciendo cada día." },
          { m: "disco_happy", t: "Y puedo seguir queriendo ganarte sin que eso cambie nada de lo demás." },
          { m: "disco_seria", t: "Supongo que eso es madurar." },
          { m: "disco_happy", t: "Aunque suena horrible decirlo en voz alta y no lo pienso repetir." },
          { m: "disco_seria", t: "…" },
          { m: "disco_happy", t: "Ah, y una cosa. Lo del marcador." },
          { m: "disco_seria", t: "Lo dejé de apuntar. Hace bastante." },
          { m: "disco_happy", t: "Fui a mirarlo el otro día por curiosidad y la última entrada era de hace meses." },
          { m: "disco_seria", t: "No lo borré. Simplemente dejé de hacerlo un día y no me di cuenta." },
          { m: "disco_happy", t: "Y eso, viniendo de mí, es probablemente lo más gordo que te he dicho nunca." },
          { m: "disco_seria", t: "Bueno. Te voy a pedir una cosa y luego te dejo, que tengo caja." },
          { m: "disco_happy", t: "Nada de partidos. Nada de notas." },
          { m: "disco_seria", t: "Cinco días. Cinco días cerrados, seguidos o no." },
          { m: "disco_happy", t: "Es lo más aburrido que te he pedido en toda la campaña y lo sé perfectamente." },
          { m: "disco_seria", t: "Pero llevo un año viéndote hacer cosas espectaculares y lo que quiero ver ahora es otra cosa." },
          { m: "disco_seria", t: "Quiero ver que aguantas cuando no hay nada que demostrar." },
          { m: "disco_happy", t: "Porque eso es lo único que se parece a mi vida, y quiero saber si tú también sabes hacerlo." },
        ],
        replies: [
          { t: "¿Quién iba ganando?", m: "idle",
            r: [{ m: "disco_happy", t: "Tú." }, { m: "disco_seria", t: "Por bastante, además." },
              { m: "disco_happy", t: "Y me da igual, que es la parte increíble." }] },
          { t: "Cuéntamelo cuando salga bien.", m: "idle",
            r: [{ m: "disco_seria", t: "…" }, { m: "disco_happy", t: "Vale." },
              { m: "disco_seria", t: "Gracias por no insistir. Nadie no insiste nunca." }] },
          { t: "Yo sigo apuntando cosas tuyas.", m: "idle",
            r: [{ m: "disco_seria", t: "…" }, { m: "disco_happy", t: "Mentira." }, { m: "disco_seria", t: "…" },
              { m: "disco_seria", t: "¿En serio?" }, { m: "disco_happy", t: "No me lo enseñes. Prefiero imaginármelo." }] },
        ],
        snap: () => ({ since: todayStr() }),
        subs: [
      ...
      /* CAPÍTULO 15 — Una última vez. El duelo final: el objetivo es solo superar la
         mejor nota de carrera, sin importar el resultado del equipo — el resultado de ESE
         partido concreto (V/E/D) se captura con resultFlag y determina la apertura del
         FINAL (ver BEKA_FINAL_OPENINGS). Camiseta: sin asset todavía (no hay icono de
         prenda genérico reutilizable en el catálogo), se mantienen todas las líneas del
         gesto y se omite solo el grantItem — ver cabecera del documento y NPCS/ITEMS. */
      { title: "Una última vez", zone: "cantera",
        objective: "Supera tu mejor nota de carrera en un partido.",
        intro: [
          { m: "celebracion", t: "Cinco días. Sin premio, sin partido y sin nadie mirando." },
          { m: "idle", t: "Eso era lo que quería ver." },
          { m: "angry", t: "Y no te voy a decir que estoy impresionada porque me niego." },
          { m: "celebracion", t: "Pero lo estoy." },
          { m: "idle", t: "Te he citado aquí y no en tu estadio a propósito." },
          { m: "idle", t: "Este es el campo donde te vi por primera vez. Ahí, detrás de esa valla, estaba yo." },
          { m: "angry", t: "Sigue siendo igual de feo. Me alegro." },
          { m: "celebracion", t: "Hoy no voy a dejarte pasar." },
          { m: "angry", t: "Ni por amistad. Ni por historia. Ni por nada." },
          { m: "idle", t: "Un uno contra uno. Aquí. Ahora. Como se hacen las cosas de verdad." },
          { m: "celebracion", t: "Y luego, el domingo, quiero ver tu mejor partido." },
          { m: "angry", t: "El mejor. No uno bueno. El mejor que hayas hecho nunca." },
          { m: "idle", t: "Porque quiero saber una cosa y no me la puede contestar nadie más que tú." },
          { m: "angry", t: "Si te vuelvo a ver en un campo dentro de un año, ¿voy a tener que seguir corriendo para alcanzarte?" },
          { m: "celebracion", t: "Espero que sí. Lo espero de verdad." },
          { m: "idle", t: "Y no quiero que esto sea una despedida, que te veo la cara." },
          { m: "idle", t: "No me voy a ningún sitio. Sigo aquí, sigo currando y sigo jugando los domingos a las nueve y media." },
          { m: "angry", t: "Esto es solo una última comprobación." },
          { m: "idle", t: "Ah, espera. Antes de empezar." },
          { m: "angry", t: "Quítate esa. Toma la mía." },
          { m: "idle", t: "Se cambian antes, no después." },
          { m: "angry", t: "Después la cambian los que se han hecho amigos durante el partido." },
          { m: "celebracion", t: "Nosotros ya éramos amigos antes, así que nos ahorramos el trámite y jugamos con la del otro." },
          { m: "idle", t: "Y así, cuando te gane, te gano llevando la tuya." },
          { m: "celebracion", t: "Que es mucho peor para ti. Piénsalo." },
          { m: "celebracion", t: "Bueno. Ya está. Ya nos hemos puesto sentimentales lo justo." },
          { m: "angry", t: "El domingo. Tu mejor nota de carrera. La borras y pones otra." },
          { m: "idle", t: "Me da igual el resultado del equipo, quiero tu número." },
          { m: "celebracion", t: "Y yo el domingo también juego, a las nueve y media, en un campo peor que este." },
          { m: "angry", t: "Así que dame un partido que merezca la pena." },
          { m: "idle", t: "Que llevo un año diciéndole a todo el mundo que iba a merecer la pena." },
        ],
        replies: [
          { t: "¿Y si gano yo?", m: "idle",
            r: [{ m: "angry", t: "Pues ganas." }, { m: "idle", t: "Y me fastidia una semana y luego se me pasa." },
              { m: "celebracion", t: "Lo que no te perdono es que te dejes ganar. Eso sí que no." }] },
          { t: "Me queda grande.", m: "idle",
            r: [{ m: "angry", t: "Te queda perfecta, no seas quejica." },
              { m: "celebracion", t: "Y además es la buena. La de los domingos." },
              { m: "idle", t: "Solo tengo dos, así que cuídala." }] },
          { t: "Gracias por aquel día detrás de la valla.", m: "happy",
            r: [{ m: "angry", t: "…" }, { m: "idle", t: "No hagas eso justo antes de jugar." }, { m: "agotada", t: "…" },
              { m: "celebracion", t: "Vale. De nada." }, { m: "angry", t: "Y ahora te voy a machacar." }] },
        ],
        setFlags: ["bekaDuelo"],
        snap: (g) => ({ since: todayStr(), matchCount: (g.matchHistory || []).length, bestRating: g.bestRating || 0 }),
        subs: [
        ...
        check: (g, s) => (g.matchHistory || []).slice(s.matchCount).some((m) => (m.rating || 0) > s.bestRating),
        resultFlag: (g, snap) => {
          const m = (g.matchHistory || []).slice(snap.matchCount).find((x) => (x.rating || 0) > snap.bestRating);
          return "bekaDueloRes_" + (m ? m.res : "V");
        } },
      /* FINAL — Desde abajo. Bloque A con tres variantes según bekaDueloRes_V/E/D (ver
         resultFlag del capítulo 15 e introBuild aquí). El pin YA NO se entrega aquí: se
         entrega en el EPÍLOGO, igual que reward, que solo dispara al entrar en la etapa
         final:true. */
      { title: "Desde abajo", zone: "discoteca",
        objective: "Alcanza la categoría Champions.",
        intro: [...BEKA_FINAL_OPENINGS.V, ...BEKA_FINAL_REST],
        introBuild: (g) => {
          const variant = g.bekaDueloRes_D ? "D" : g.bekaDueloRes_E ? "E" : "V";
          return [...BEKA_FINAL_OPENINGS[variant], ...BEKA_FINAL_REST];
        },
        replies: [
          { t: "Lo hiciste.", m: "happy",
            r: [{ m: "disco_seria", t: "…" }, { m: "disco_happy", t: "Ya lo sé." },
              { m: "disco_seria", t: "Pero está bien oírlo. Una vez. Solo una." }] },
          { t: "¿Todavía llevas el papel?", m: "idle",
            r: [{ m: "disco_seria", t: "…" }, { m: "disco_happy", t: "Sí." },
              { m: "disco_seria", t: "Pero no lo he desdoblado desde aquel día en el parque." },
              { m: "disco_happy", t: "Que para mí es prácticamente haberlo tirado." }] },
          { t: "Yo también empecé desde abajo.", m: "idle",
            r: [{ m: "disco_happy", t: "Ya lo sé. Por eso te elegí a ti para todo esto." },
              { m: "disco_seria", t: "Había gente mejor a la que perseguir aquel año." },
              { m: "disco_happy", t: "Pero ninguno bajaba a defender córners en el minuto ochenta." }] },
        ],
        snap: () => ({ since: todayStr() }),
        subs: [
          (g) => g.tier.id >= 6,
        ...
        check: (g) => g.tier.id >= 6 },
      /* EPÍLOGO — Nos vemos en el campo (última etapa: final:true, sin objetivo propio).
         Cierre de los tres motivos de la campaña: la ficha, el marcador y la excusa para
         hablar. Pin: ya existe como carta (beka_pin, kind:"card"), revelado a mitad de
         escena igual que Elisa/Yuna. reward (+1 MEN) movido aquí desde el FINAL. */
      { title: "Nos vemos en el campo", zone: "discoteca", final: true,
        introBefore: [
          { m: "disco_happy", t: "Champions." },
          { m: "disco_seria", t: "Lo dije en esta barra hace un año y me miraron raro." },
          { m: "disco_happy", t: "Ayer se lo recordé a los tres que estaban ese día." },
          { m: "disco_seria", t: "Uno se acordaba. Con uno me vale." },
          { m: "disco_happy", t: "¿Sabes qué es lo mejor de todo esto?" },
          { m: "disco_happy", t: "Que ya no necesito una excusa para hablar contigo." },
          { m: "disco_seria", t: "Antes tenía que encontrar una forma de competir. Un reto, un marcador, un número." },
          { m: "disco_happy", t: "Ahora puedo simplemente venir. O que vengas tú." },
          { m: "disco_seria", t: "…" },
          { m: "disco_seria", t: "Te tengo que contar una cosa que pasó el jueves." },
          { m: "disco_happy", t: "Estaba buscando el DNI en la cartera y no encontraba el papel." },
          { m: "disco_seria", t: "El informe. La fotocopia doblada en cuatro." },
          { m: "disco_seria", t: "Y tardé como diez segundos en darme cuenta de que lo estaba buscando." },
          { m: "disco_happy", t: "Diez segundos en los que no supe dónde estaba y no me dio nada." },
          { m: "disco_seria", t: "Ni un pinchazo. Nada." },
          { m: "disco_happy", t: "Apareció, por cierto. Estaba detrás de la tarjeta del gimnasio." },
          { m: "disco_seria", t: "Pero llevo siete años sabiendo exactamente en qué pliegue de la cartera está." },
          { m: "disco_happy", t: "Y el jueves no lo sabía." },
          { m: "disco_seria", t: "Eso es lo más cerca que he estado nunca de tirarlo." },
          { m: "disco_seria", t: "Y ahora sí. Lo que te dije que faltaba." },
          { m: "idle", t: "Toma." },
          { m: "idle", t: "Este sí es un regalo. No es logística, no es una pulsera y no es una camiseta prestada." },
          { m: "angry", t: "Es un regalo y lo estoy diciendo en voz alta, así que disfrútalo porque no se va a repetir." },
          { m: "angry", t: "Y no lo pierdas." },
          { m: "disco_happy", t: "Bueno… si lo pierdes tendrás que volver a verme para que te dé otro." },
          { m: "disco_happy", t: "Así que tampoco sería un desastre." },
        ],
        introAfter: [
          { m: "disco_happy", t: "Bueno. Vete ya, que tengo que cerrar y tú tienes entreno." },
          { m: "angry", t: "Y no te emociones con todo esto. Sigo queriendo ganarte." },
          { m: "disco_happy", t: "Algunas cosas no tienen por qué cambiar." },
          { m: "disco_seria", t: "Nos vemos en el campo." },
        ],
        replies: [
          { t: "¿Y el marcador?", m: "idle",
            r: [{ m: "disco_happy", t: "Lo miré la semana pasada." },
              { m: "disco_seria", t: "La última entrada es de hace ocho meses. Ibas ganando cuatro a once." },
              { m: "disco_happy", t: "Y he estado a punto de ponerme al día." },
              { m: "disco_seria", t: "Y he decidido que no. Que ese marcador está bien como está." }] },
          { t: "Nos vemos el domingo a las nueve y media.", m: "idle",
            r: [{ m: "disco_seria", t: "…" }, { m: "angry", t: "No hace falta que vengas." }, { m: "disco_happy", t: "…" },
              { m: "disco_seria", t: "Ven." }, { m: "disco_happy", t: "Detrás de la valla. Como hice yo." }] },
          { t: "Tíralo.", m: "idle",
            r: [{ m: "disco_seria", t: "…" }, { m: "disco_happy", t: "Algún día." },
              { m: "angry", t: "Y ese día te voy a llamar por teléfono para que lo oigas." },
              { m: "disco_happy", t: "Prepárate, que va a ser a una hora horrible." }] },
        ],
...
export default function App() {
  ...
  const checkStories = (g) => {
    ...
    Object.entries(STORIES).forEach(([key, def]) => {
      ...
      /* resultFlag (ver BEKA_STORY 3.0, capítulo 15 → FINAL): permite que la etapa que
         ACABA de completarse calcule una flag dinámica a partir de su propio snap y del
         estado justo en el instante de la transición (p.ej. qué resultado tuvo el partido
         que cumplió el objetivo) — algo que next.setFlags, al ser una lista estática, no
         puede expresar. Se fusiona con el setFlags normal de la etapa siguiente, así que
         esta sigue sin necesitar saber nada de cómo se calculó. Se aplica también a `out`
         ANTES de construir `beats`/introBuild (y no solo vía setFlags diferido) porque
         introBuild necesita ver la flag ya en el momento de decidir qué texto mostrar, no
         solo cuando el jugador termine de leer la escena. */
      const resultFlags = stage.resultFlag ? [].concat(stage.resultFlag(out, st.snap) || []) : [];
      if (resultFlags.length) resultFlags.forEach((f) => { out = { ...out, [f]: true }; });
      const nextStage = resultFlags.length ? { ...next, setFlags: [...(next.setFlags || []), ...resultFlags] } : next;
      const beats = failed && next.introFail ? next.introFail : (nextStage.introBuild ? nextStage.introBuild(out) : nextStage.intro);
      out = enterStage(out, nextStage);
      out = queueStageScene(out, def, key, nextStage, state, beats);
      pending[key] = true;
