...
const YUNA_STORY = {
  ...
  chapters: [{
    ...
    stages: [
      /* PRÓLOGO — El primer gol (rework de diálogos, ver
         FUTABITA_Yuna_Rework_Narrativo_para_Code.docx — no toca objetivos ni
         comportamiento, solo sustituye el texto de las escenas). Mismo fix de
         contradicción temporal que Elisa/Milly/Nina: los bloques de reacción
         "cuando el jugador vuelve tras cumplir el objetivo" se han movido al
         PRINCIPIO de la etapa siguiente. El documento usa el mood [suave] una
         vez (capítulo 9), que Yuna no tiene — sustituido por "idle". */
      { title: "El primer gol", zone: "barrio",
        ...
        intro: [
          ...
          { m: "idle", t: "Simplemente me ha llamado la atención." },
          { m: "barcelona", t: "Y además quería comprobar si el chico que marcó ese gol juega siempre así o ha sido una casualidad." },
          { m: "angry", t: "Eso es todo." },
          { m: "blush", t: "Así que... si vuelves a marcar, quizá vuelva a mirar tus estadísticas." },
      ...
      { title: "Motivos estadísticos", zone: "barrio",
        ...
        intro: [
          { m: "idle", t: "Bueno... supongo que ahora ya tengo una razón para volver." },
          { m: "happy", t: "Si hay más datos interesantes, claro." },
          { m: "angry", t: "No pongas esa sonrisa. No significa que vaya a estar siguiéndote." },
          { m: "idle", t: "He estado mirando tus números." },
          { m: "idle", t: "Goles, minutos, rendimiento... cosas normales." },
          { m: "idle", t: "No es raro que alguien mire las estadísticas de un jugador que acaba de marcar su primer gol." },
          { m: "blush", t: "Bueno... quizá las he mirado más de una vez." },
          { m: "angry", t: "¡Porque quería comparar!" },
          { m: "idle", t: "La cuestión es que ahora tengo una duda." },
          { m: "idle", t: "Quiero saber si aquel gol fue un momento aislado o si realmente estás empezando a mejorar." },
          { m: "blush", t: "Y para saberlo necesito verte jugar otra vez." },
          { m: "angry", t: "No porque quiera verte a ti. Por los datos." },
          { m: "idle", t: "Así que juega tu próximo partido." },
          { m: "happy", t: "Si ganas o vuelves a marcar, tendré algo con lo que comparar." },
        ],
      ...
      { title: "La tienda", zone: "tienda",
        ...
        intro: [
          { m: "happy", t: "Vale." },
          { m: "idle", t: "Ahora ya tengo una comparación." },
          { m: "blush", t: "Y... ha sido bastante mejor de lo que esperaba." },
          { m: "angry", t: "No te emociones. Eso no era un cumplido." },
          { m: "idle", t: "Te veré en la próxima jornada." },
          { m: "angry", t: "Solo para comprobar si mantienes el nivel." },
          { m: "barcelona", t: "No digas nada." },
          { m: "barcelona", t: "Estoy comparando materiales." },
          { m: "idle", t: "Este tejido es mejor que el de la temporada anterior." },
          ...
          { m: "idle", t: "Además, después de verte jugar un par de veces, supongo que ya tengo derecho a saber qué cosas te gustan." },
          { m: "blush", t: "Bueno... quizá no tengo derecho." },
          { m: "happy", t: "Pero puedo preguntar." },
          { m: "idle", t: "En fin. Voy a mirar unas cosas." },
          { m: "angry", t: "Tú también puedes mirar. Pero no pienses que he venido contigo." },
        ],
        snap: (g) => ({ matchCount: (g.matchHistory || []).length }),
      ...
      { title: "La bufanda equivocada", zone: "tienda",
        ...
        intro: [
          ...
          { m: "idle", t: "Además, si vas a seguir jugando, al menos puedes llevar algo decente." },
          { m: "blush", t: "No estoy diciendo que necesites mi ayuda." },
          { m: "idle", t: "Solo digo que... me gusta que tengas algo que te recuerde a mí." },
          { m: "angry", t: "¡Eso tampoco era lo que quería decir!" },
          { m: "blush", t: "Olvídalo." },
          { m: "idle", t: "Solo quiero comprobar que sigues mejorando." },
          { m: "happy", t: "Y si vuelves a marcar, quizá me haga un poco más fácil seguir diciendo que todo esto es por las estadísticas." },
        ],
      ...
      { title: "El Barça y tú", zone: "parque",
        ...
        intro: [
          { m: "blush", t: "Has vuelto a marcar." },
          { m: "happy", t: "Bien." },
          { m: "idle", t: "Supongo que la bufanda ha traído suerte." },
          { m: "angry", t: "¡Es broma!" },
          { m: "blush", t: "...Aunque podrías seguir llevándola." },
          ...
          { m: "barcelona", t: "A veces ni siquiera recuerdo el marcador." },
          { m: "idle", t: "Recuerdo una canción, una camiseta, una persona que estaba conmigo." },
          { m: "blush", t: "Supongo que por eso me gusta tanto guardar cosas." },
          { m: "idle", t: "Una entrada. Una bufanda. Una foto." },
          { m: "blush", t: "Cosas que parecen tontas hasta que pasa el tiempo." },
          { m: "idle", t: "Y entonces las miras y recuerdas exactamente cómo te sentías." },
          { m: "blush", t: "Supongo que... algún día podría pasarme lo mismo con otras cosas." },
          { m: "angry", t: "No he dicho que contigo." },
          { m: "idle", t: "Pero quizá estaría bien tener otro recuerdo que no fuera solo un partido." },
          { m: "happy", t: "Aunque primero tendrás que ganar uno." },
        ],
        snap: (g) => ({ matchCount: (g.matchHistory || []).length }),
        subs: [
          (g) => (g.player.streak || 0) >= 3,
      ...
      { title: "La pregunta incómoda", zone: "barrio",
        ...
        intro: [
          { m: "happy", t: "¿Ves?" },
          { m: "blush", t: "Ahora tengo otro recuerdo." },
          { m: "idle", t: "Y este sí que me voy a acordar." },
          { m: "angry", t: "No porque seas tú. Porque fue un buen partido." },
          { m: "idle", t: "Tengo una pregunta hipotética." },
          { m: "blush", t: "Y antes de que respondas, es hipotética de verdad." },
          { m: "idle", t: "Si alguien te siguiera mucho, viera tus partidos, se acordara de tus estadísticas..." },
          { m: "blush", t: "...¿te parecería raro?" },
          { m: "angry", t: "No estoy hablando de mí." },
          { m: "idle", t: "Estoy preguntando en general." },
          { m: "blush", t: "Imagínate que esa persona empezó siguiendo tus partidos por curiosidad y luego empezó a esperar cada jornada." },
          { m: "idle", t: "Y que quizá se acuerda de cosas que tú ni recuerdas." },
          { m: "blush", t: "¿Te parecería extraño?" },
          { m: "angry", t: "Porque yo creo que depende de la persona." },
          { m: "idle", t: "Si es alguien que solo quiere saber cosas sobre ti, quizá sea un poco raro." },
          { m: "blush", t: "Pero si es alguien que simplemente... disfruta viéndote mejorar..." },
          { m: "angry", t: "¡Da igual!" },
          { m: "idle", t: "Olvida la pregunta." },
        ],
        replies: [
      ...
      { title: "El estadio", zone: "estadio",
        ...
        intro: [
          ...
          { m: "idle", t: "He visto muchos partidos, pero estar aquí contigo cambia un poco las cosas." },
          { m: "blush", t: "Porque esta vez no estoy mirando desde lejos." },
          { m: "happy", t: "Estoy aquí." },
          { m: "blush", t: "Contigo." },
          { m: "angry", t: "¡Como experiencia futbolística! Eso quería decir." },
          { m: "barcelona", t: "Además, quiero guardar la entrada." },
          { m: "idle", t: "Algún día la miraré y recordaré este partido." },
          { m: "blush", t: "Y quizá también recuerde con quién estaba." },
        ],
      ...
      { title: "La foto", zone: "estadio",
        ...
        intro: [
          { m: "happy", t: "Ha sido increíble." },
          { m: "blush", t: "No solo por el partido." },
          { m: "idle", t: "Creo que este es el primer recuerdo que siento que compartimos de verdad." },
          { m: "angry", t: "No te acostumbres a que diga cosas así." },
          { m: "happy", t: "Espera." },
          { m: "blush", t: "¿Nos hacemos una foto?" },
          { m: "angry", t: "¡Para mí! Quiero decir, para recordar el partido." },
          { m: "idle", t: "La entrada está bien, pero una foto es diferente." },
          { m: "blush", t: "Porque cuando la mire dentro de unos años quiero acordarme de cómo era todo ese día." },
          { m: "happy", t: "El estadio, el partido..." },
          { m: "blush", t: "...y nosotros." },
          { m: "angry", t: "¡No he dicho 'nosotros' en ese sentido!" },
          { m: "blush", t: "Aunque... tampoco estaría mal." },
          { m: "idle", t: "No voy a enseñársela a nadie." },
          { m: "happy", t: "Bueno... quizá a una persona." },
          { m: "angry", t: "Pero solo porque seguramente me preguntará de dónde la he sacado." },
        ],
        setFlags: ["yunaPhoto"],
        snap: (g) => ({ matchCount: (g.matchHistory || []).length }),
        check: (g, snap) => (g.matchHistory || []).length > snap.matchCount },
      ...
      { title: "Celos", zone: "parque",
        ...
        intro: [
          { m: "blush", t: "Ya está." },
          { m: "happy", t: "Ha quedado bien." },
          { m: "idle", t: "Creo que voy a guardarla." },
          { m: "blush", t: "Esta sí que no quiero perderla." },
          { m: "celosa", t: "¿Quién era?" },
          { m: "idle", t: "No me interesa." },
          { m: "celosa", t: "Bueno, sí me interesa un poco." },
          { m: "angry", t: "Pero no porque esté celosa." },
          { m: "idle", t: "Solo quería saber quién era." },
          { m: "celosa", t: "Hablabas con ella como si os conocierais bastante." },
          { m: "angry", t: "Y ya sé que puedes hablar con quien quieras." },
          { m: "preocupada", t: "Eso no es lo que me molesta." },
          { m: "celosa", t: "Lo que me molesta es que me haya importado." },
          { m: "blush", t: "Antes no me pasaba." },
          { m: "idle", t: "Antes te veía como el jugador que había marcado aquel gol." },
          { m: "preocupada", t: "Ahora, cuando alguien se acerca a ti, me pregunto cosas." },
          { m: "angry", t: "Y odio preguntarme cosas." },
          { m: "blush", t: "Porque creo que ya sé cuál es la respuesta." },
          { m: "idle", t: "Pero todavía no estoy preparada para decirla." },
        ],
      ...
      { title: "Lo que no digo", zone: "casa",
        ...
        intro: [
          { m: "preocupada", t: "Perdona por antes." },
          { m: "idle", t: "No quiero controlar con quién hablas." },
          { m: "blush", t: "Solo... me sorprendió descubrir cuánto me importa." },
          { m: "angry", t: "Y eso es culpa tuya." },
          { m: "blush", t: "Más o menos." },
          ...
          { m: "idle", t: "Desde aquel día del parque no dejo de pensar en lo que me está pasando." },
          { m: "blush", t: "Últimamente me pongo nerviosa contigo por cosas que antes no me ponían nerviosa." },
          { m: "idle", t: "Cuando me escribes. Cuando te veo después de un partido. Cuando me acuerdo de una conversación que tuvimos." },
          { m: "blush", t: "Incluso cuando veo la bufanda." },
          { m: "angry", t: "Y no sé qué hacer con eso." },
          { m: "preocupada", t: "Me da miedo decirlo y que después todo cambie." },
      ...
      { title: "Una tarde sin fútbol", zone: "playa",
        ...
        intro: [
          ...
          { m: "idle", t: "No necesito que respondas ahora." },
          { m: "blush", t: "Solo quería que supieras que detrás de todas mis excusas hay algo real." },
          { m: "playa", t: "No te acostumbres a verme así." },
          { m: "playa", t: "Hoy no quiero hablar de goles." },
          { m: "playablush", t: "Ni de estadísticas." },
          { m: "playablush", t: "Ni de tu rendimiento." },
          { m: "playa", t: "Quiero que tengamos una tarde normal." },
          { m: "playablush", t: "Sin excusas." },
          { m: "playablush", t: "Solo tú y yo." },
          { m: "playa", t: "Me he dado cuenta de que casi todos nuestros recuerdos empezaron alrededor del fútbol." },
          { m: "playablush", t: "El primer gol. La entrada. La foto." },
          { m: "playablush", t: "Incluso la bufanda." },
          { m: "playa", t: "Pero quiero saber cómo somos cuando no hay un partido de por medio." },
          { m: "playablush", t: "Quiero hablar contigo sin necesitar una excusa." },
          { m: "blush", t: "Y sí, me pone un poco nerviosa decirlo." },
          { m: "happy", t: "Pero me apetece." },
        ],
        setFlags: ["yunaDate"],
      ...
      { title: "La segunda bufanda", zone: "tienda",
        ...
        intro: [
          { m: "playablush", t: "Me lo he pasado bien." },
          { m: "blush", t: "Mucho." },
          { m: "playa", t: "Creo que esto ha sido una cita." },
          { m: "angry", t: "No me hagas decirlo otra vez." },
          ...
          { m: "idle", t: "La he visto y he pensado en ti." },
          { m: "blush", t: "No por ser del Barça." },
          { m: "idle", t: "Bueno... también." },
          { m: "blush", t: "Pero principalmente porque sabía que te gustaría." },
          { m: "angry", t: "Ya está. Lo he dicho. ¿Contento?" },
          { m: "idle", t: "Supongo que después de todo lo que hemos hablado ya no tiene mucho sentido seguir fingiendo." },
          { m: "blush", t: "Aunque todavía me da vergüenza." },
          { m: "happy", t: "Pero quiero que tengas algo que te recuerde a mí." },
        ],
        snap: (g) => ({ ovr: calcOVR(g.player.stats) }),
      ...
      { title: "La discusión", zone: "barrio",
        ...
        intro: [
          ...
          { m: "preocupada", t: "Y no quiero ser la persona que te diga que abandones algo por mí." },
          { m: "angry", t: "Pero a veces siento que yo solo existo cuando tienes un hueco." },
          { m: "preocupada", t: "Y no quiero sentirme así." },
          { m: "angry", t: "Porque cuando empezamos a pasar más tiempo juntos, pensé que quizá esto podía convertirse en algo de verdad." },
          { m: "blush", t: "Y ahora me da miedo que tu carrera sea tan grande que yo acabe siendo una parte pequeña que puedas olvidar." },
          { m: "preocupada", t: "Sé que no es justo." },
          { m: "idle", t: "No quiero controlar tu tiempo." },
          { m: "blush", t: "Solo quiero saber que también hay un sitio para mí." },
          { m: "angry", t: "Porque me importas demasiado." },
        ],
        snap: (g) => ({ since: todayStr(), matchCount: (g.matchHistory || []).length }),
        subs: [
          (g, snap) => daysGoalsCompletedSince(g, snap.since) >= 3,
      ...
      { title: "Sin excusas", zone: "parque",
        ...
        intro: [
          { m: "preocupada", t: "Perdona." },
          { m: "idle", t: "No debería haberte hecho sentir que tienes que elegir." },
          { m: "blush", t: "Tu carrera es tuya." },
          { m: "enamorada", t: "Y yo quiero estar a tu lado, no delante de ella." },
          { m: "happy", t: "Solo... necesito que me dejes formar parte de tu vida también." },
          { m: "blush", t: "Tengo algo que decirte." },
          { m: "idle", t: "Y esta vez no es sobre el Barça." },
          { m: "blush", t: "Ni sobre tus estadísticas." },
          { m: "idle", t: "Ni sobre el partido de ayer." },
          { m: "blush", t: "Me gustas." },
          { m: "angry", t: "Mucho." },
          { m: "blush", t: "Y me da vergüenza decirlo." },
          { m: "idle", t: "Llevo meses buscando excusas para estar cerca de ti." },
          { m: "blush", t: "Primero eran los números." },
          { m: "happy", t: "Luego los partidos." },
          { m: "blush", t: "Después la bufanda, la entrada, la foto..." },
          { m: "enamorada", t: "Y al final me di cuenta de que ya no necesitaba ninguna excusa." },
          { m: "blush", t: "Quería verte porque eras tú." },
          { m: "enamorada", t: "Y quiero seguir estando contigo." },
          { m: "angry", t: "Así que ya está." },
          { m: "blush", t: "Lo he dicho." },
        ],
      ...
      { title: "Juntos", zone: "casa",
        objective: "Completa un hito de carrera y una victoria.",
        intro: [
          { m: "enamorada", t: "No sé qué va a pasar después." },
          ...
          { m: "happy", t: "Mucho." },
          { m: "idle", t: "¿Sabes qué es lo más raro?" },
          { m: "enamorada", t: "Que durante meses estaba convencida de que tenía que esconder lo que sentía." },
          { m: "blush", t: "Y ahora que por fin lo he dicho, parece mucho más sencillo." },
          { m: "happy", t: "Bueno... excepto cuando me miras así." },
          { m: "blush", t: "Entonces sigo poniéndome nerviosa." },
          { m: "enamorada", t: "Pero ya no necesito fingir que no me pasa." },
          { m: "happy", t: "Y tampoco pienso volver a esconderme detrás de una bufanda." },
        ],
        snap: (g) => ({ tierId: g.tier.id, seasonNum: g.season.num, matchCount: (g.matchHistory || []).length }),
        subs: [
          (g, snap) => g.tier.id !== snap.tierId || g.season.num !== snap.seasonNum,
      ...
      { title: "El recuerdo", zone: "estadio",
        ...
        intro: [
          { m: "enamorada", t: "Me gusta estar contigo así." },
          { m: "blush", t: "Sin tener que inventarme una razón." },
          { m: "enamorada", t: "Creo que podría acostumbrarme." },
          ...
          { m: "enamorada", t: "Ahora me da más miedo imaginar que algún día podríamos olvidar todo esto." },
          { m: "happy", t: "Así que voy a guardar la foto." },
          { m: "enamorada", t: "Y la entrada." },
          { m: "blush", t: "Y probablemente la bufanda también." },
          { m: "happy", t: "Tengo demasiados recuerdos tuyos ya." },
      ...
      { title: "Por una vez, sin excusas", zone: "estadio",
        objective: "Alcanza el nivel de élite.",
        intro: [
          { m: "enamorada", t: "Otro máximo." },
          { m: "happy", t: "Parece que todavía no hemos terminado de ver hasta dónde puedes llegar." },
          { m: "blush", t: "Y me gusta pensar que voy a estar ahí para verlo." },
          ...
          { m: "idle", t: "Recuerdo aquel primer gol." },
          { m: "happy", t: "Recuerdo cómo intenté fingir que solo me interesaban tus estadísticas." },
          { m: "enamorada", t: "Recuerdo la bufanda que supuestamente sobraba." },
          { m: "blush", t: "La entrada. La foto. Nuestra primera cita." },
          { m: "enamorada", t: "Incluso nuestra primera discusión." },
          { m: "happy", t: "Supongo que una relación también está hecha de esas cosas." },
          { m: "enamorada", t: "No quiero ser solamente alguien que te mira desde fuera." },
          { m: "enamorada", t: "Quiero seguir estando contigo mientras descubres hasta dónde puedes llegar." },
          { m: "blush", t: "Y sí, me da vergüenza decirlo." },
          { m: "enamorada", t: "Pero ya no necesito esconderlo." },
      ...
      { title: "La bufanda", zone: "casa", final: true,
        intro: [
          ...
          { m: "enamorada", t: "Y yo he estado aquí para verlo." },
          ...
          { m: "blush", t: "Y ahora cada vez que la veo me acuerdo de la primera vez que intenté esconder que me gustabas." },
          { m: "happy", t: "Creo que no se me daba demasiado bien." },
          { m: "enamorada", t: "Aunque tampoco me arrepiento." },
          { m: "happy", t: "Después de todo, gracias a aquella excusa empezamos a hablar." },
          { m: "enamorada", t: "Y mira dónde estamos ahora." },
          { m: "blush", t: "Así que sí." },
          { m: "enamorada", t: "Guárdala." },
